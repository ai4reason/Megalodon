...
Definition missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (BinRelnHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_410622e3fa4d1ae12fb82f85251a565809529fe30441b930469a668485b1c285 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_da94b08dae292949e42a2ac744478f7a4e3fd6cd6f33c2d36fc5bee60b86e043 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ef8023c6b527f74c1b9fd876d0322180298b60ffaba0fe3c17cc245f552ff0e7 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_45fbce07f73e4097d236a8dd62dd3e22617490edbeaf04b31ff0fcd2d1c9fba9 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d975f4a02f479eaee7c44829de74beb7f2510d7f087b6cf6ced68d0588773261 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_59620d8f9df7a7d16c327de359cba9295820eb0ab876c322571759dc40c76b59 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fade6dfc52e15f14e3662591cca687b502b92f81d599ac9dc4aafec8d09d2371 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5afe8836bc51e7fb24d9725c5b578b265e7f00d50634a741b4fabfc08d908ce4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e5e550b4b0455f9a5923b4733e6d145eeea4b67d3ecbfa53a45755aba5135ee9 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f5ccd7963358d5d1704365f36e72d020e6cf748ece2874dae7e6686f717e9ff5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4725030848eef71eaffcb90642be5fe2f442129a07e8622c1dfd6b66155a4af8 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5f37faed41db701bbba1dd2ac619ac217a67f824ce5680884b334b3b46cf79c9 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_r_p_e missingname_c689b9d43ec5d6ba07d474f0f47d4236d693455ef61cfbf907ba5c98a4d0f38b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
