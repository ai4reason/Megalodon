...
Definition missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (MagmaHom x0 x1 x2) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_7d2e679c9ee3c43705008e655ac509c1c692b81a3231fc67877aa0bcefa7b373 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0e4d119ba2089a6fa730ac6b33e0646906ea377736a1ff64a9fb8bc8cd3bcc43 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b8161716c3d8780c9eb03804c52aebd15ed25e71aa17ad009cffaf41b6bac3cc : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f79ec1bbacfafafbaeb43bfcc6f36d0765ba75bddc2e127b46b6a5bcbb282bcf : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_837cfd58edd0556de5081bf9a22cc8db9baa8de07d6fa3ad241f4bf09587b780 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_15c33ab2d97f6277b1fd91a023ff9b4f713a007668dd4cd2e6e63c6a8585b132 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e1ba895eed870066151424a260c36bc7cc12ebd2bcc4e434b382f6e8f9679902 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c334dd406a690d53e669ef7a647ed1d4b5013fcfed124fa034c4185460e0669f : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c2fe75bdab0805e18306b14c74ad36b2fc4abed3bb75b7e0519b31e1ca72dcf2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_457be3d8466aaca9b22a237330958983dd49e8181599ac16aaf65746e914bd87 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_380a5d05975c5a2cf385441fabf4c66fadec0f8771e346b897d199831fecd5ab : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c2c108a661d715516f88c0a85fdedc72f028f1ccf953c6165792706a4dffdc10 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_r missingname_4bb893192df4e2751fce5600fb6128d8759ca428a9f66ecae56f39f4a27eed2b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
