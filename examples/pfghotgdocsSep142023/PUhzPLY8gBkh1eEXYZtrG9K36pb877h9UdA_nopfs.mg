...
Definition missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_45e90fce02ec0d5552753b503999554cf3542e34618bd0d7754667f8404cfa4d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_409b990bb23e16e92b2a68f859c1a4ae9d7c93ac3221eec4c90f9e1faa7eeef5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0fbc9d15d654a02a4db4db3776470f1cedb52a8c8dafa0e5cae7b4baa5e8103c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9f4ebf6d5129dff0e2d4fc741a79186dd889840eb6641e5caeb6765cc4920674 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_937496ec836a4b18581c9146396306d9173c9c92aca5316fdff8842063662c37 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cfbdd3cedafff87fa21d3b27924dbf1c555ea00334d27a4de8c4c0df6f4b88b5 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_92bb8bc056cc07ba7330d1d79c483a4503d75525632a49e193154ba0f9d20d77 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e0953aebf833ce61c27ced6b38f9d3d4255cb9257d07cefdd7abf38607dde486 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f41802076a4f0b407eb352a65a63a732b9c667c30e05017aa826445f06db426e : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8cce358a2176ccfab1f92355fad710180664572bb00d11c114529f7fe5701bc8 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fcae872d02915d4ab58ec256816a366a3878d6953464c0d6d8054bfec6561652 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_74beabf673fb05fc14bff6be6afcc28f82ee49c4b1f974398e9a72bf5306c644 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_p_e_e missingname_a10fb45bfb6ec562e93981ab7015a0cdaabe8f70ab4641863d7025d4a7ef15e1 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
