...
Definition missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_f2573ef6ddf7c1a4a670754b1a453bcabd5d8251011d7a6104af9dfa129ab744 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7509a2478722da23c93031f25dc1e0cc9026e5c9c7bc1e9d8a3dcbd5ce08ce89 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_18bf67884cd74e39ce16e4adac01813fa4bf69c13fe0640031bd9644c9a3ff55 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f59422ca89c052d779b032b5cc5c27e1d24a6eecf5d1d19435e436909ba7fe8f : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7fad93432ff02b4619e12ee2a3039f5cea1ac0f672ca6d457d93f1cdeee80389 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_64ace2ca258bf2d9c6f5c762f59672597762697a78fccac60c737a375a8e0d79 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a3b23e85bcd3307f886423cbcbce6ad3fbc429f0256d049d72eb77979fcde6bb : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f8d3355cc9c4454389b06508e6ac52e31790512279a4465248a5c5da81645563 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e8a2dd08c5fd1b7151138eefb355992f4bbad14b4ec2b8c2c242efc98cca9f24 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_04c5fd0de34717020742b4e57564cd43976a5852f9ec75721a3a006ac11d0789 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5c02ca907d41f93e2c9e74e5bc1e480ff3d757ede65f1242705fffd1920b4b89 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_48c024ca8d9485d9ef1a178e414c003babb32951a8e1ded75a4cace5bbb80af1 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_r missingname_e0ffebfbe7547ca89fb1f688150409aeeed20184efffcc4be75d198472469836 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
