...
Parameter explicit_Ring : set -> set -> (set -> set -> set) -> (set -> set -> set) -> prop.
Definition CRing_alt : set -> prop :=
 (fun x0 : set => and (struct_b_b_e x0) (unpack_b_b_e_o x0 (fun x1 : set => fun x2 x3 : set -> set -> set => fun x4 : set => and (explicit_Ring x1 x4 x2 x3) (forall x5, x5 :e x1 -> (forall x6, x6 :e x1 -> x3 x5 x6 = x3 x6 x5))))).
...
Theorem missingprop_8ccfb9c38ac5d74623bcc9a43784b2aec899aed4b19a5d0636eded98177992db : MetaCat CRing_alt Hom_b_b_e struct_id struct_comp.
admit.
Qed.
...
Theorem missingprop_367b3e47ee21a5535aa4c098c13104356d41b48b5bbf8ae403a980d742e1abc4 : MetaFunctor CRing_alt Hom_b_b_e struct_id struct_comp (fun x0 : set => True) HomSet lam_id (fun x0 x1 x2 : set => lam_comp x0) (fun x0 : set => ap x0 Empty) (fun x0 x1 x2 : set => x2).
admit.
Qed.
...
Theorem missingprop_37f6f7fb3fd81245bab3403e21f08bcfb7e905d2d5ff76923d4d0c538ee9673f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_68df42987dd53c3ab749199df59ddda30a27253ba229c52184fee1d4a12d4963 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_98f1e6a106fae025aa4d195029dbb14340fe071c7e74b015371be9e4092947d0 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8843e19222c08eb3a0a0bd30a853878164a656defbd48115dac0ee66c0bd8e28 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c705a90668a4181f56498dae2a5493b483c403e2d0dd821c0e8fd6c25b666c12 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dcaa3a89b0de65241aebbc86e55a6884d6d2f68e60854dbba3250df857b32965 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b8918f1d1e184f0e9667364917b9398e47cc623fef7e62da8c2d826cc99433e6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dd3b82768c48f76204f281d864cdc2595ee7c8f2029eecb7ffb645409c6af7a4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_102164adac3b557fff08fc11bf8b41220092f83550781eff6cb3cc5fc8be5b79 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3918b611a2248ec5b4f77e580c9542ff36bc52067f1b8dd90a2c9d743bed894b : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) CRing_alt Hom_b_b_e struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
