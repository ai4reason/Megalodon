...
Definition missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryPredHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_616192cd6dbafe795f573f761ef43ab31c5f8aed3ccc0050cfc14089ff1e561a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_80df258ba265867501606192037a7b9aa18ef87e93aacd25db4df44de090e297 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f5574c5ff2828d7b4298a86572caf2f3b5b4a27d9cccab29bbf9f46620de3743 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3086b2bb8d2a4e9ed69e35d15fb993ef8baef188c07ca1e490e4fd0176510021 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_828e4a6f80fdffd0038c256b73c2dc62ddea084e5953a925fc30d518360d61bd : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3e0353f9f3cd655f1d86d384293d1a09280b6d77b80981328cf311bed231b52c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f0b9fa3014a2110ee865423af672c6199fbf573ee38269d1f0c28684fc863489 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5f9ab73cd32d41b7d8a58e600de681407a0cc5e813240020994ee6f97f495cad : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7afa99f4ad2fa3b07dd370032b24cbe38d18e0565cf327f56566dccec692e78c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_aaea0975d6dfb64346dc96d4a19b3e8f610837c276c0d2d9d2c8784c94e6a35f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_47c0e8d5328c20ff7b76565233ed89af6bf71e91d3a25b048dad782131fce19b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1dcd28375f6294c8f5496a0cf82593f6943435fe696b567f92abf5a47a26d0fd : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_p_p_e_e missingname_fabe8c1f8f7df9ad39c1d0b07c5efbd72ce1532391132256f764a6524d4a233b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
