...
Definition missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_5d19dfc250cca07d6e806d8d39a65d45f13ac40cf70f23ea7cb717050b7aa362 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a85ab7fae2a74bd91b189f3baac2cc0ad96d052b31873390fc1e91ac2e71b93f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b706dae79661d9f631b3665c0b559f38f230a817c318d4d00fe715c15cd3cb02 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4ead1c3d0f25b32df3d04b008df04b383ec57bfd9cfaeab6bc24ba4628230325 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_624d5858793eab11ed2b0a826fab8d69eb74edc17272f3336c567e77a2350afd : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6147d36020102ad70745e662dda947d6d709b592c77d8df160c69229ff6a4af5 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e1624ea11fcef349257f5b8a424af614445b6c77891180a0577e030b8f5a1c24 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4ff445aeee149ddad309189a472f1343400247925e9a5f8f1cac97b985051308 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1524bfb43e39b5f2c79f1d1319546bad4190e7cc76428981647e813614fe40a4 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_67f3c4d5511b79988b195455a62af336ed2b2d29feaf3f0a9c0be913058cd19a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7d062762ebca7b860b688df2cde49d0379d7648a1c776a2411dc385af1e84b03 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_p_e_e missingname_5a5179dc58597ee3f8ac8a7eac631c84ae13ec6d729e3e4970051c69f6e075e4 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
