...
Theorem missingprop_a1e277f419507eb6211f44d9457aefea2a8b3e26b2ee84f0795856dfe97fcf6e : (forall x0, x0 :e u8 -> Church17_lt8 (u17_to_Church17 x0)).
admit.
Qed.
...
Theorem missingprop_46a7f5ba218e301f19d33cc265134a2df7adfd3de64e750dc665649ee8f6340d : (forall x0 x1 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, Church17_p x0 -> Church17_p x1 -> or (TwoRamseyGraph_3_6_Church17 x0 x1 = (fun x3 x4 : set => x3)) (TwoRamseyGraph_3_6_Church17 x0 x1 = (fun x3 x4 : set => x4))).
admit.
Qed.
...
Theorem missingprop_7319a473fd0d307c236781359af918832684b744b55bc12dd159dbca12e12419 : (forall x0 x1 x2, (forall x3, x3 :e x0 -> or (x3 = x1) (x3 = x2)) -> atleastp x0 u2).
admit.
Qed.
...
Axiom setminus_setminus : (forall x0 x1 x2, forall x3 : set -> set -> prop, x3 (setminus x0 (setminus x1 x2)) (binunion (setminus x0 x1) (binintersect x0 x2)) -> x3 (binunion (setminus x0 x1) (binintersect x0 x2)) (setminus x0 (setminus x1 x2))).
Axiom setminus_selfannih : (forall x0, forall x1 : set -> set -> prop, x1 (setminus x0 x0) 0 -> x1 0 (setminus x0 x0)).
Axiom setminus_idr : (forall x0, forall x1 : set -> set -> prop, x1 (setminus x0 0) x0 -> x1 x0 (setminus x0 0)).
Theorem missingprop_d80a5cdd35aff682e6edc37d56782355ff9ceaa0a69a0eeabe526b6102deafb2 : (forall x0 x1, forall x2 : set -> set -> prop, x2 x0 (binunion (setminus x0 x1) (binintersect x0 x1)) -> x2 (binunion (setminus x0 x1) (binintersect x0 x1)) x0).
admit.
Qed.
...
Axiom missingprop_ac637069183b0ef4f1754ba500cebdf1fc690defd66bf5aa2631e325b804843b : (forall x0 x1 x2 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, Church17_lt8 x0 -> Church17_lt8 x1 -> Church17_lt8 x2 -> TwoRamseyGraph_3_6_Church17 x0 (fun x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 : set => x12) = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x0 (fun x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 : set => x13) = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x1 (fun x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 : set => x12) = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x1 (fun x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 : set => x13) = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x2 (fun x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 : set => x12) = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x2 (fun x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 : set => x13) = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x0 x1 = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x0 x2 = (fun x4 x5 : set => x5) -> TwoRamseyGraph_3_6_Church17 x1 x2 = (fun x4 x5 : set => x5) -> False).
...
Theorem missingprop_c6065f04fc36f1dd031027d33d4c8c7929436124d555d05e64a74013e516cd3e : (forall x0, x0 c= u12 -> atleastp u5 x0 -> u8 :e x0 -> u9 :e x0 -> (forall x1, x1 :e x0 -> (forall x2, x2 :e x0 -> not (TwoRamseyGraph_3_6_17 x1 x2))) -> False).
admit.
Qed.
...
Theorem missingprop_3d93e88f531d875f7ea35bd0b47ed56b619941ce54d80b63241ab3167d710c44 : (forall x0, x0 c= u12 -> atleastp u5 x0 -> u8 :e x0 -> u10 :e x0 -> (forall x1, x1 :e x0 -> (forall x2, x2 :e x0 -> not (TwoRamseyGraph_3_6_17 x1 x2))) -> False).
admit.
Qed.
