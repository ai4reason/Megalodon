...
Definition missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (UnaryPredHom x0 x1 x2) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_c15412854ee85d9260b52707a5b2b54ebfc4543e3829f980077eda9259fb3431 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ffe0cdf9d4c8eb56ed9cd924db59753c7df616b2e1c46bc06eb7b242525fd0fa : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b5620b31b855b313a576df1a5070d2977f6725bc38a85e50af14865afacd3349 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b55c95007da80794cca8875eecf09fdcb5f95c5bdb64beef89e043be914a6ea2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c8d1c3dbaf0d2deb796193f00af0b759251d1c8fa2a689b66d1b63b44680a595 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f70d473692acb569b9cfeb7f6f73b508f55a5f8df2167299ca59be866f3fd638 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_856a17b7140b48f3c4716813f6a32eeafb8d4105b920799830a39c0764ce2635 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d04ffb72f7f8ecaf50b4871629af750bda0b7cb7a98193ff340956bb9018d0aa : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f99fdeb323b5a36ba72c0cea18227db56be2d448330cc65f2324cd52aa43c5e5 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b16943b5b7dcfae5bad2bb7a0d886956718f2a9d77ac15dda6e2a72988e6e40e : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_74b62a184f623936546a58419e4d4d6015a0bd3f97c6b30e39fb4544a886b4c1 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_41a0b44c1a912888514b4229591ab81d5ffb8d853d34bf43596291c417ddaea3 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_p_e missingname_78192b2acedafc8eb95ee78b41f1ca99c19dd53eb5e3415aef2bef8140834c05 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
