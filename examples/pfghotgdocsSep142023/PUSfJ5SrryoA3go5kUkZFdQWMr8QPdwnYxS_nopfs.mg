...
Definition missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryFuncHom x0 x1 x2)) (UnaryFuncHom x0 x1 x2)).
...
Theorem missingprop_c41fb92ff973f9af965f980ef8cfd9589d1b50fc6590d877c273225e30f0c063 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3bc694613c0f07e1c7c4653040488787d595a500be7d0926e351340c7217fc9a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d2ab4d06eff411ffee1c91dc8acf61e1d459f819fa0f8c49dfb7b549aa6aef8f : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_99604a22b220a63b926fdae6a0922aecacb9501e2bb67d3f1dff3c635904b0d0 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c217cc72b97736603d4814d5280bede8f6852c892ee149fe69548cc2fbc300de : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_26acd1e57f3002e3ab88d3715037406c12ea1d96d732dba0ebdc4c22949abdbf : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a07cddb7ea27be9861a7ed8da4c84fd9c90104421c63083f8738e5f381e63c66 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_89baa0786062e0e6e1bf9600801eaff08c5a5d948d3182665fba60c9e517f885 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b8a78b8c59e5f495f48209e229c300da2ae5407982b38dfcd9c47b7f4804898e : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_391ce09963a696dcc92b9d1b7f2f27893504fb701e95448d75760561234a2551 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7f17a177f458b4468e83ad817ea3fa6f2e76799cd5a685b9dbeb922ab5b6087c : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_u_u missingname_e50073ea3ab6a9f6778a69273d4bf906cd36a17f2aca7aae563c5121b33ef33b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
