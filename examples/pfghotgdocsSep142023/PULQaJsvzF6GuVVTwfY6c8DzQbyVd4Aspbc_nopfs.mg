...
Axiom missingprop_89e2eb6499d465cb37e817a31f95856dfa9b168146cc6a6ad11f5d81ab3acc1e : u20 = u2 -> (forall x0 : prop, x0).
...
Axiom missingprop_30f1f82af278170c3ed53f12b42890b23ec31927a4144332729ee690d5df91fd : u20 = u3 -> (forall x0 : prop, x0).
Axiom missingprop_5d321fe05d298f9b82e1ef2345c3662d2863eb255cfdb8ea8a195276f4d32e73 : u21 = u3 -> (forall x0 : prop, x0).
...
Axiom missingprop_14a2ac1a43d21520b7831fbcaac1f5f2e89edd725bea1f7cfa899266892e1179 : u19 = u12 -> (forall x0 : prop, x0).
Axiom missingprop_5486a56db2cedc933a2e1073f30437ac31b8b12326559a2446f92bef4c49218c : u19 = u13 -> (forall x0 : prop, x0).
...
Theorem missingprop_a5e3063f876c9d3e4d1ef26c4f9153e0de3a9a1239634d24dd302223fefd3aeb : (forall x0 x1 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, forall x2 x3 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, ChurchNum_3ary_proj_p x0 -> ChurchNum_8ary_proj_p x2 -> ChurchNum_3ary_proj_p x1 -> ChurchNum_8ary_proj_p x3 -> x0 = (fun x5 x6 x7 : (set -> set) -> set -> set => x1 x6 x7 x5) -> ChurchNums_3x8_to_u24 x0 x2 = ChurchNums_3x8_to_u24 x1 x3 -> (forall x4 : prop, x4)).
admit.
Qed.
Theorem missingprop_a96350eecd2f0e8109ed5c948068295ce0de74960368fd5a52dc6bf598ec7689 : (forall x0 x1 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, forall x2 x3 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, ChurchNum_3ary_proj_p x0 -> ChurchNum_8ary_proj_p x2 -> ChurchNum_3ary_proj_p x1 -> ChurchNum_8ary_proj_p x3 -> x0 = (fun x5 x6 x7 : (set -> set) -> set -> set => x1 x7 x5 x6) -> ChurchNums_3x8_to_u24 x0 x2 = ChurchNums_3x8_to_u24 x1 x3 -> (forall x4 : prop, x4)).
admit.
Qed.
...
Axiom missingprop_21103d0116af4f897e55974109368c145947a3a66515039db1a0c8b178a98166 : u23 = u17 -> (forall x0 : prop, x0).
...
Theorem missingprop_498fcc6018d7e2437bdd74f18e666c6536b12613b32c6aec7efb4f948a395c31 : (forall x0 x1 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, forall x2 x3 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, ChurchNum_3ary_proj_p x0 -> ChurchNum_8ary_proj_p x2 -> ChurchNum_3ary_proj_p x1 -> ChurchNum_8ary_proj_p x3 -> TwoRamseyGraph_4_5_24_ChurchNums_3x8 x0 x2 x1 x3 = (fun x5 x6 : set => x6) -> ChurchNums_3x8_to_u24 x0 x2 = ChurchNums_3x8_to_u24 x1 x3 -> False).
admit.
Qed.
