...
Theorem missingprop_cd9a3abf4761fff79dc29990e20341f4a8da3587995e1914fa480d4087ab3f2e : MetaCat missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp.
admit.
Qed.
...
Theorem missingprop_3e3cab6dc8d5bbf29edec6e9fe5d7ce502d26e83dfca4d4e3ad784883337c726 : MetaFunctor missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp (fun x0 : set => True) HomSet lam_id (fun x0 x1 x2 : set => lam_comp x0) (fun x0 : set => ap x0 Empty) (fun x0 x1 x2 : set => x2).
admit.
Qed.
...
Theorem missingprop_90972f3a644e4e21938ce0ed12bb4bb9fe66c7f30dc619591ee20abd10a4c804 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2c096c26c2aa79e57281f0474ad86b337bc65366ac604ee66c955ba66e47f7ff : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8053aeb8d884ad43bc442bb5214e6b351bb20cda01c4776038671ec9da6c8937 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3810a69db74847359a0386ac6087ccd1aee26f9851df2363999b67934725dad5 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_37a333ba290c350dfdb0acd299e42f0ead8d8fd8e2d1a4a6de3befc5503e2e4e : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0abf3e5d58924d35b7255854b89ee14b256eae55fddae78b8c2fe9ad4bff1d00 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) missingname_8d0d9cf1964756488df42d4d5626c938343caad15d945c8e45b8f2b2d2fdc383 BinRelnHom struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
