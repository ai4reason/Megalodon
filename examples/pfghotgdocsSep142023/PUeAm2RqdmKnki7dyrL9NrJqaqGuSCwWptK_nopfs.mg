...
Definition missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (PreContinuousHom x0 x1 x2) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_5d076bdc0cdee7ce11e11eae5df1a12776db1130e96a551b8fd62ed31af8c777 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3476ee986cff482fccde8a4a1d4a5f907403084483a25a4c5354601704e7fddd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fd9187d18495ad454e5b02736d461a1155e385a1c8f5529256e2415ef9821682 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1eb75cdcd674755eb2eb004ccd44a2307f3d2937a84a629d78110b926d2020e4 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b208f1ccf75f0feea035be2da24af64d270110a15a28e08cab7a98b3c8b49355 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f1ae052fe10edccebc97956a38f398ad95eff309738991b542b1e5587430cb7e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e57458c565e4572b1f93f12b873da4ae7def694c38dab64fa6b6bd3b17657a6e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6c80814522009100d6947a2ee663335e9a181fc28c90050f6d3b41529d4101f9 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_907b258dc4904aa9ed25eb4a296eb4cd1faa759f87dbc367f7606496fa229691 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b1744daf3b46744bc3210b1b9e4a63b19a5c00aa7f99099463cfb2a5c0b898be : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f1924a2f4e2ba4bb8bc7f8aa5df7a456d04014ddb3d087750a1fad873f7534fd : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_e missingname_5a542e441a54515fa809abca800598c1d1538d26e2b7ca7c635d63fd2eedb991 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
