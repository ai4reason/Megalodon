...
Definition missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_eeae525e4efa61965d02ca707c80512ba9d766a75e442165058b97bc9b191359 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5c8362a7394f105a437c9fd765d20ca49f20e2d8e3b9b2b9baa21df2289343a9 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_66d973ff050fc1308a8fcc84c8ec10fa44f577a67111f48552b7bd2a7be8bd94 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6f90d272bb7ae6a120fe7b296e0c99f6f38d317fd0383e72f912c00cd3e8171a : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1e41e0334ba647d0a66d4082f80013da7b66af4cb100e4faf54b295d015d98b3 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6006d334cbfdaaa7ecfea74486b3f067790c9a4e6a9479d4c732a49cd1156574 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_346da18d29ce237abfe6062c842251a37982a1381fe22afcc9bf7ec5df671d35 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_36873497d7ac1e668d30680bef05a92848f3f937df83f232de46f988e650aba4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1e5c31b55287cc3d006044cf1d08b008a47f9ab592dce2a1af69004771cb954c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_adef3e4cf6a7783053fc9972a44434f05527e4465afbe2406a848654bef4aaca : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_df4a307cb06e53a04daa2f9fc26fee0670a54178cbe3db9d06eaad257a78d580 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_u_p_p missingname_dadd4ccc5989e425c934f1e79b78a24f4fdbae0a270d06f541a45f84e224b67a struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
