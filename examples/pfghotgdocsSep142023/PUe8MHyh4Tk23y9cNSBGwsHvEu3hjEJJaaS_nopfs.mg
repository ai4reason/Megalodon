...
Definition missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_7e945d87610e223acc146cc1c1120feda806ca7e4e98601c30e523f81bb04898 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cb5995b7ece17f819fd031b330d50dde2ff24d097101710cb69296db19748b54 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b3ff37868003bb730331811f572f66cd86230f3e07b41f576537d0abcaba554e : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_130bff45450175281460f54284cf88a77183d2cab9979f98f7f31a3e757be6e8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_034add4602e70664843f52cb45424aad9c02646a406a7193c6c6c777f0dc5afa : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_992b095712a07647346718fd137cbe2a2f0091af32cf3df0010fb8717945ebb2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b725ebf3abde8f88c5a9df9c8d422c2d0adb067a37c40a44ffd7373c51f1f306 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6ca5fa0335e7408033040a5ef6ab25d7fde81fc9541aa02dc149bd1c7772fa52 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_45bfdc54d654a2ddc82b10154db89a007a3c6962baa08decdd529dbef83b4df4 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e3fd43a114ec9356153fb3152d3a33c38ce34a0dc5c7a2a2e7d0e1e7484c0355 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_63b1d89865a7ebcde65938a609c0d09114be9130e0fc935967d31b1b61a8eccb : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e11fbe713404f8c37122e0dcc8b9575507794edff13164ae75b455de75f3ce70 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_r_r missingname_b1ea3624a120fc9ca987c3cd57e4fc461690bb0f6ffc4e4b83a727a6a0d65cf4 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
