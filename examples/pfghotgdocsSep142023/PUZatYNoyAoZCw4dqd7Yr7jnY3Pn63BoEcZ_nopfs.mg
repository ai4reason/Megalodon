...
Definition missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (UnaryPredHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_b2955308cb58cb4831bb8a03bdea4e0009d3bea97aa53bbb00c7ab6cb2a7e0bb : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_397894574807bbed912f7f2a370a4ade51fb03800e24fca85d86db36b4afa8c0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_02bd3ca1a178c41282580d41c58d194e4183418393600d3654eb233766022275 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e9c33b45599fa609bdf044141b03cab07fa031cbaa4bca40c93c17289c70a576 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2cfc3a9918af4f1f8f92e09290748b049e12ff39777184021eeb67411296aa52 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_493e7bc1ad99649ea9b2d143f018058e66bb936fbe95afe3464769a436451001 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f6414a9c39e875be868380491e6127bfba2af48ce3fe713853738a3f4ab0cc7e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2ff0217d7fab5253c5960107d9a958018ed5327138868f9237cff4043cc55b67 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0ada507f941bb73b5d0558d4aac5f4ec056f86cb66d91d51f57494e74006a3bf : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e98578863dc5e12909148c568b46cd80605ac49cf5c54db6fb8b4d3e75d537db : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cafc4c4e86088e7376cb68f57e8773ac025870e3bb7cc849f231cb09a03e7235 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5427216a1c0313094c619f2a53b64ea0689f2fbb40c2a20c7f1783ab192a5e39 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_p_p_e missingname_d902e355420d54c71a6a65dfc5ed18d0550fdf2de7c279f77efa471a5d3e113f struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
