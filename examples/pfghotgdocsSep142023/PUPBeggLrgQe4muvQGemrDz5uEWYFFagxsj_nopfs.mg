...
Theorem missingprop_821eaea8d64656981d4b09109b645b96ecc6f05951f146b66e41a13f047d2a83 : (forall x0, x0 c= u12 -> atleastp u5 x0 -> u8 :e x0 -> u9 :e x0 -> (forall x1, x1 :e x0 -> (forall x2, x2 :e x0 -> (x1 = x2 -> (forall x3 : prop, x3)) -> not (TwoRamseyGraph_3_6_17 x1 x2))) -> False).
admit.
Qed.
