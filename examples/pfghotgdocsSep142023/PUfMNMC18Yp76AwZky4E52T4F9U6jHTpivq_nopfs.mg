...
Definition missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (PreContinuousHom x0 x1 x2) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_b215b3e2b89ee7cd082837036deb1fee7caa394ea0a416ff7574d0b0b973c368 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0d754d51d2bc41dffba4a2cca01905463e5393e0f7feb7728a55461f784a3d19 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dbb433ca73ac0c2ad72c4d762008e5486723ed11c14e96cbfa6aec7db77de443 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9da488bbdfed67c6d479ad33c470a23d21bcae226634177cd1dfcc66b17b826e : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d488492fc4342ef44ea9829c7ef1fc3033fb85bde03c3dd7f11b64c17d022218 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9e5950972feebf96e625d4e5d0fddfc589f3c7a0f880e9d0144a697cb6c3622c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_af2cd5e8994d87a1046e27d046c871c462ae9fbdd57f7a945849057e6af826d3 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0053bc84c9ac56f5406b53fa8e01c273531a7a2aae37499d115f5fc060c71223 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_53393aea28efe7606f76eee04e249f25c29edd2e54270d8afef556fe4485bdb6 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8a62da68f505e92dfcbd22b3883fa59f02282323860226ef9bc544588c7e9541 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1d120208b33c96a0d829aefc6fa82ec5b44124b7426c308676537045c630b089 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f68f6a0179086a85d029a275491e370f9145782c3555ea09fcdf3ecebf954bcb : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_p missingname_86f1cee1f31e361f6ad639c18f2dac1ccfc4c01cdaa21738248c47fdb9928907 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
