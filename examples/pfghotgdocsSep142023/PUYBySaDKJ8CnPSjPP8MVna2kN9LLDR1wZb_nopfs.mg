...
Theorem missingprop_be55e404d4ac2d4091ecd4b4a3ada4dfe6f6c5b63fffb8d2ae0ce3dc1cb10d7e : (forall x0 x1 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, forall x2 x3 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, ChurchNum_3ary_proj_p x0 -> ChurchNum_8ary_proj_p x2 -> ChurchNum_3ary_proj_p x1 -> ChurchNum_8ary_proj_p x3 -> x0 = (fun x5 x6 x7 : (set -> set) -> set -> set => x1 x6 x7 x5) -> ChurchNums_3x8_to_u24 (ChurchNums_8x3_to_3_lt5_id_ge5_rot2 x2 x0) (ChurchNums_8_perm_3_4_5_6_7_0_1_2 x2) = ChurchNums_3x8_to_u24 (ChurchNums_8x3_to_3_lt5_id_ge5_rot2 x3 x1) (ChurchNums_8_perm_3_4_5_6_7_0_1_2 x3) -> (forall x4 : prop, x4)).
admit.
Qed.
Theorem missingprop_3499359b0d768e57e1edb8c809aa62f4e28526ac9fe33203bf124c26a13cf71b : (forall x0 x1 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, forall x2 x3 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, ChurchNum_3ary_proj_p x0 -> ChurchNum_8ary_proj_p x2 -> ChurchNum_3ary_proj_p x1 -> ChurchNum_8ary_proj_p x3 -> x0 = (fun x5 x6 x7 : (set -> set) -> set -> set => x1 x7 x5 x6) -> ChurchNums_3x8_to_u24 (ChurchNums_8x3_to_3_lt5_id_ge5_rot2 x2 x0) (ChurchNums_8_perm_3_4_5_6_7_0_1_2 x2) = ChurchNums_3x8_to_u24 (ChurchNums_8x3_to_3_lt5_id_ge5_rot2 x3 x1) (ChurchNums_8_perm_3_4_5_6_7_0_1_2 x3) -> (forall x4 : prop, x4)).
admit.
Qed.
