...
Definition missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (BinRelnHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_48891d40086f6d95d0a1fb87879b03c10658287d69dea8489e88dae5e9dcc1fe : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_118e56aa76fddac14c87021df8dce494d265cfc4d96d9b279094e165c2d3173f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_64e1c66aedd0a0f7f4972aedc49e01219ba3089d9d32e6cdbd761d6e890617a3 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_605e7fa0d20553237d4c22a69a03ca095dec7571dc4474e3d7c2dbe7a7239dd0 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5826b1fcd486e09d0e87872e8750e7aef072a53858ff4091d2aa2680dacdf093 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_30b54ce8b1967b55d83871fedc0608eb6cd357f45814b3ea6c1a4f47094dbac2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8c5f473301c2934b963688425c38c5691cea4d8173a7a47c13f79a9a7029170d : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_89180790842e4258e09fbc3ef493d6c08246411d6847242b6d8d39af08590633 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e25ce7be8d71fc4398fc86ea6f6379eda4cf546d8fd28c9d1016beb81139b4e8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a9d306f209e337b51457368e1a602f76ea279f04108127adf5ceffce3fe91a45 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7b299bbb008c6a4fb652a1adbb36f2fc18f2c9fa50c3acc1ec0bd35858314205 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8c2b46c88aa979fd148ab23df295c1959646a7f46f96f8a98817461dac4b90f3 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_r_p missingname_53bf837bdfd103933ab2f040093b1189b555446de54e9ee5e1c2f70cc36b4770 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
