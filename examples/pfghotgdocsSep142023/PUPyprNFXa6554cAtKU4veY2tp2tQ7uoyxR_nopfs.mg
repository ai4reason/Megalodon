...
Definition missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_23f23af46c5dc9308b0144697be1d2f170e9cee4536c5c37cadf812122bde6b3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c52b64a3456ff6b7e52af540dd3ba9b91948dda23abd3e7f3c229c8c56ab05b8 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4a07bfae46afcfd01c8e444ba427582891390c38419e889543ba097dfdffc9e6 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fe3af2b51a437e3fe9f6c6f5d1ccb73681e9a1846846fb06b2a932987eb832d5 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7c0cc912ea2eafa492241a96e74f76e18b9ebf2f7ddaa2e1f81b42aa40706f95 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9ef45209bfecac7a69ed0308efad02b609b9b57a2ec202644e096092901726a8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fb78b9fdaa97977b428f28c5d22ae7ff73b2c296493b535c84d599fdca32178e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d24794070f9c197b3cd990b0f8fa00e76e9bdd104df7d74caf7cf5ecba1b3414 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_39f97a8226f48938eebf67c22ffac4498c73e42bf530824115d208c4d378b0a9 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_41b00ee86bbaed8407d917a364cffaccf66ea5e9bb4e099b7f4c03de1e2c2f08 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6bec305d60fb40c1158de6efa4a1011737df38a54a92d7084325997cf8ca5355 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_r_e missingname_75a7a724fce499d35384c35432bdbff000759dbbec87e82084f9e0679b5de93b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
