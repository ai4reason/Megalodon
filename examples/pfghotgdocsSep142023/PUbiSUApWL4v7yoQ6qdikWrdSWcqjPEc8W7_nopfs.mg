...
Theorem missingprop_c8f4c6132c330d292a33ed857f1378dfa11f59a06ab198d38d5ce3df4b16ca8f : (forall x0 x1 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, Church17_p x0 -> Church17_p x1 -> (fun x3 x4 : set => x0 x4 x4 x4 x4 x4 x4 x4 x4 x4 x3 x3 x3 x3 x3 x3 x3 x3) = (fun x3 x4 : set => x3) -> x0 Empty u1 u2 u3 u4 u5 u6 u7 u8 u9 u10 u11 u12 u13 u14 u15 u16 = x1 Empty u1 u2 u3 u4 u5 u6 u7 u8 u9 u10 u11 u12 u13 u14 u15 u16 -> x0 = x1).
admit.
Qed.
