...
Definition missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_c55f9cd87729e239ce0ae5554e7e707e6caba4fc4e6b18c690162a8eb4714906 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dc76cb986e737b17a3554d7e0b33b2ddabb3845299c0cdaaa9fa0e643a1db457 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8061b1f973c82b9e6a9ea4328dd8fc780c6069845eb72275242846f3ff30348f : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_de44b47bec9db45dfa37f73ac3eaaabbbb66db459c6b86108df2d89959fb840e : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_232a967c36045805c6c43e8f42fcd7e9aed41eb8f748bc732f30cc704112b501 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a0a5e3f2060be30525590ad8168b8ec80fed5188c125129f14c7ca833854bade : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9fd6bf1872332a790acabb3ec370f82791a31f8839af730c1016c3e43ccb0e2c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_882bef4e19af215a2c383161064188746f14026922c2555e1561f94ca44fb9e7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bc4f56efef605f7af7d1ae82ce3dc6843a2ab7e6295e285456b6867aeb792159 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_224a98ebdb999da5865e8c0961c11462057c56efaf2ef16fe25e10fce603e0cd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5f36e60f246c450d741ddc51cf8574e4d036a1aadd0524aa043c9a1042e25cd8 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_75ba3e60e587dddd88d10926398a1f8d07413b56e51e80686c2cb6b6b67684cd : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_r missingname_4d79e75e5894e007d4b498e1f804820d244776e39aa9febf5d06a915fcb18127 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
