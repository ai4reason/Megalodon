...
Theorem missingprop_7e9017d62df3b585f78cad4527ff9b2593a867d8dc049c8df6cd74b9e8aa8862 : (forall x0 x1 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, forall x2 x3 : ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> ((set -> set) -> set -> set) -> (set -> set) -> set -> set, ChurchNum_3ary_proj_p x0 -> ChurchNum_3ary_proj_p x1 -> ChurchNum_8ary_proj_p x2 -> ChurchNum_8ary_proj_p x3 -> x0 (fun x5 : set -> set => fun x6 : set => x6) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 x6)))))))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 x6)))))))))))))))) ordsucc (x2 (fun x5 : set -> set => fun x6 : set => x6) (fun x5 : set -> set => x5) (fun x5 : set -> set => fun x6 : set => x5 (x5 x6)) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 x6))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 x6)))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 x6))))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 x6)))))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 (x5 x6))))))) ordsucc 0) = x1 (fun x5 : set -> set => fun x6 : set => x6) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 x6)))))))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 (x5 x6)))))))))))))))) ordsucc (x3 (fun x5 : set -> set => fun x6 : set => x6) (fun x5 : set -> set => x5) (fun x5 : set -> set => fun x6 : set => x5 (x5 x6)) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 x6))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 x6)))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 x6))))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 x6)))))) (fun x5 : set -> set => fun x6 : set => x5 (x5 (x5 (x5 (x5 (x5 (x5 x6))))))) ordsucc 0) -> and (x0 = x1) (x2 = x3)).
admit.
Qed.
