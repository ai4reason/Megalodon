...
Definition missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (MagmaHom x0 x1 x2) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_3be38f9c04497d7166235916908e7a4da86f9715948be76ed5830e3f7580f2f1 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9cae3c7bcc42b877a0865aa708f0bd3e7e14c125b4137ce15fa83d1482f0190f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_953875a8b326e9e69cd17498dee8246238c96fceb2b12e710ff88b2b2e68f76f : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e6d8850e7920bda00c837550e65e8e179ffb5fedf46ffb5c2df2d6c7ec747e02 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5d0d5f7add2f2bff33c178e04c1183e524009788327b0c982443cbc48bbf6d60 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c0fc198e53b8e79a297ce47769e27ef814f074811cc04e0aa35348e18b219f16 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_707b5ff946772bd83eba08d9fe094ff25a88600ba1aced10b00b855202d3e2d0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bd42ccf58139935ecbc1e799efe1c769e45717bf6aa7747f9737266a5465b451 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_35a5e1b0cd42c2540132f4d91bf1d95c671b41335d6bbd1e4f39098626a1742b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2d2955fad889dec8d3ecf19fad67ec0c944961a540073ba76b7e38339bf9e30a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5fea36f85bdb33c2cbe4dae3b7d2ff7d18d77ebe16521a033f66622991256445 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6bfd186daa2c51b95c143d688c2486635a248e6f257b1659cf372092d274acf1 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_p missingname_160c572e6136203f28cbff2ecf4a50e1cb754552d2b25399e5fba310beb2689e struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
