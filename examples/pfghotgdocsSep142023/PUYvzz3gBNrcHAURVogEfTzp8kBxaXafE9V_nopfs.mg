...
Definition missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_b0744111798707ccf3f8759a4edad5336eea7da847a2656d8d71714bc285aeb3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8a8fdbdaf85be58d37db6cb5654b2d0404097cffbe6b06f0ce81b27aead4bfba : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1ac13868f0b339764aeec4e71b062e6f7dd9c734b58d38d637613fab1751d950 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_91ee974d0b8348613ab0b2beab769d135fe18f8a209bb634f654c222ada4163b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_004e3128c19c17d29459a93cf9048cc5b259258461b788220d435f0942cb3f53 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_03e013a78c168cb365260d95696b75443f84cebf8ddb228de6451ca9c7e7bd1e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a428968b3359767a75a5a7a6fb897ea22d2b0e3009a1d008652283835ee67dbd : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_675b45db4b74dd5f66589b677932101307d024db16944a2bd905c351b589f3b6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_191c27dbfabd99944d854d270cf4999844ca0331417132e08f1aade6519c95bd : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b38fb005d71c19cadeb8f71addd7892220cfb29ea4da36f50c5c658a7d87a43a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_776de28ea4602a2a66771004df0522f6780edfcebdbc06c61360be249fab5c3a : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_e missingname_1f98216c6fac659bc64edbfd0dcbcb5b8c7a8f4e7097cb34d900c8bf154af1df struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
