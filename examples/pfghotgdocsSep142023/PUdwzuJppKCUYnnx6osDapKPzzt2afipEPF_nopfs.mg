...
Definition missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_4b3aa937a00a50189de3e5db6a981c63acad7748057e7ad572a3e14b33a8e6ae : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_089c83804d47d2112a3e9f7b8b80e717f802dc680e128851e158b1592d6c7539 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e9fa5130efb2766dcf8ad197f231944cea8620798c8c910915f09f22fbdcaa04 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e49d1c2024c002d201a1fddfc5688fbef7b9bc2990a9526a1e238b58664b856c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3398b59cbce1168ecb4688012dfa8f113145f2ab8128c5dbcef61f17bd355d3d : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4d5bd306ba7c36cc593d17ab5e9e0e6432c10d7363ee6dab291af1dbdc7bcfe6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1e2ca4910b4cb03c8ef6a6069b04ec9447e6638800d63547027339ff0f14351e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1b1928e87f1d054181458a1dbcd5e8e4b12536fe2abf4c611670d17d28af44ff : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b2b5a3984f07c5549d7349721651f3e97425bf298506e28540386d5c6708a3ca : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_74299bfa7cad0509bc08d21a7d325d10c546eecbe0c73baf898069c02f361874 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fdf11bba9a444f4c36fe13e38c7d2ae181e0d3bbdacbc50cd150bb8538ad0f69 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_64c99e5d45ad782c16d352f81d322867dea528d8512b3206677734e16ba94deb : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b_r_p missingname_f60a0937df03b899d7fadba4f31918b5b513b0a0f774f9b77917fda6453e032d struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
