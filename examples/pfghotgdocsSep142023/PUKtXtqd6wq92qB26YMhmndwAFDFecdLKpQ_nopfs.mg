...
Definition missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_665272b26c18c263824886dcd6519d248b5f452c9a67a4c0465b9b8668ac8614 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5319bfcb65f92da4e2809950e5a8eb8a4a26abe5327fd80874c7d80f86fce1e3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8f78557bfc6e3c0b99045b4dfb48d6e17774ccfd1f97a1c65d318c2e63c6c20e : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ac6cde0fcb05399fe5d070d2386d83d101c77bd6ce9c6021f31d35b9678cd9ae : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e71dc183f02c3947376876aba60cb97ed367e890cff9f96c2074eb07f6613a81 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_53c67a204530fbf349aefb1eba7520a67e99ddf9bc2491e588216b2f02293dcf : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_11efda70015209734b77d0f72e9a244eb747c91efad3a6266b7be831438a2829 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_304553229df22a71e03d4654bb634285b6e00c63eb1b7bfb3321f2600ecea927 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_998a4e4196f3edd36c9c7b59197fc89a6c8ddc5ceb48a9a6f3c53c047a6f8660 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d491b2763a1f052af7d0110333458bf5954fc34523c4705dc3c5a379415c591c : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_97f67ca9de16fa66c56ffd215af7471461ac25030ccb66162df0607804638ede : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fbe6896f478296246bea2e92a8b292d5e855f98ed3cb497c0211b1ae1822936e : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_r_e missingname_5b1d79a1ead8b97f29c2169ac7ddb95c5d4e32c3c12d4f437a37e4209d053881 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
