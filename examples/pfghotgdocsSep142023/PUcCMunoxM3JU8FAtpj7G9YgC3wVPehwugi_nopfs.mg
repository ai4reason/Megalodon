...
Definition missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_34213eba83a4bbd7a006b172692ca43653caf4747005f536897b769c3c503eba : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0cb34d6f9fd5335282d4e3d48180dcf5aa8e4800be0774f74bb46baec3e47041 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dff0469d99206e26eb85603445f3e32de88ab51653523acd834794121c6e0f32 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d0f0f9435dec244c7781467355e055f7230c028acaab02537aa218dd77630596 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5c055d48a7d8943da0f760083c1e86a8682ad300adffcb4ededea63613ee41e5 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2ee5ba0804fc03d019cd05bbc7cc09e6da7d6688ef0bc4ce345d5daefbcfceb7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6d75f8494171e201e4826745ef795e49cb0907a109b406a1a73f7b46189bf57a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7e2a3a0eff5d13585d74eff4faf0ba1e87e003e0fd7d9ef5ecb4dbdf0d60e405 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b6c0c8a1eef4b016fdf3a29053d6b5f69d669285be88da1dd8515dcf0bfc1eb7 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1acd5d2ca5b1237a7edf9e25cea48929c120bc8466d31eaac21560cd0efd373e : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_242fcc1938cf2acb32d4c2e7202543e84ea7b6239936d338cdcb8441aa7f39d9 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_172279492971e002e5ae348e998d6f4351f6f90e6d907aa2418272e0b7569eac : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_u_r missingname_ddd4f21f245720de4f41579ea9b15046d5adb124d82fbf8f9e5c5dc438120741 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
