...
Definition missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_1978016861af4d13bd9b9a464574ae058dafd5dbce52305b26f6614be169792b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0888979cb03837c0b2181f3ae26bc966780a6a3b326f14b10874317c57e65243 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_07a2d4394805ea0357017b8ac03585d2a0a7f0f894ca15ca99bbad11fb9b22b8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6d4c4fc3d7b10b36548db27a8bb80329b494e28b7f02159020f206dd7373b776 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bc08dc3866c8ef5e429915022f4599b2c9cef57c9395f2ceabd25383ef5236cd : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_db1326b6c8888480e6a113462c7b5aa04eaa407db5472266fe491c306ecb1e17 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cc8926dd9f5107b9a4d5b2273dc4fe0837e8a52a6b7c5c48179f1ee1bdc25e0c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_22a918ceebc7428b4ed8028efac4e191bbbd8c4b82d021cb289a61b9736865a6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a29236f7cfd4c02da0cf1a03d5b4346e3d7b1e27440ad2b99b1ca99ed098fc65 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d30c227712c4b3092971c11286794e5ab5a6dc5d80071b2f234f70c8d6fe4758 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fc32098bcd778a1f912b5df228150514604dce3172cda5ad4a6d192556c559f8 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_r_e_e missingname_bebe26d9ab32f6d9cf02cefd65d6629ca45c02d33378c996298f6e9515d13b21 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
