...
Theorem SNo_approx_real : (forall x0, SNo x0 -> (forall x1, x1 :e setexp (SNoS_ omega) omega -> (forall x2, x2 :e setexp (SNoS_ omega) omega -> (forall x3, x3 :e omega -> SNoLt (ap x1 x3) x0) -> (forall x3, x3 :e omega -> SNoLt x0 (add_SNo (ap x1 x3) (eps_ x3))) -> (forall x3, x3 :e omega -> (forall x4, x4 :e x3 -> SNoLt (ap x1 x4) (ap x1 x3))) -> (forall x3, x3 :e omega -> SNoLt x0 (ap x2 x3)) -> (forall x3, x3 :e omega -> (forall x4, x4 :e x3 -> SNoLt (ap x2 x3) (ap x2 x4))) -> x0 = SNoCut (Repl omega (ap x1)) (Repl omega (ap x2)) -> x0 :e real))).
admit.
Qed.
...
Theorem SNo_approx_real_rep : (forall x0, x0 :e real -> (forall x1 : prop, (forall x2, x2 :e setexp (SNoS_ omega) omega -> (forall x3, x3 :e setexp (SNoS_ omega) omega -> (forall x4, x4 :e omega -> SNoLt (ap x2 x4) x0) -> (forall x4, x4 :e omega -> SNoLt x0 (add_SNo (ap x2 x4) (eps_ x4))) -> (forall x4, x4 :e omega -> (forall x5, x5 :e x4 -> SNoLt (ap x2 x5) (ap x2 x4))) -> (forall x4, x4 :e omega -> SNoLt (add_SNo (ap x3 x4) (minus_SNo (eps_ x4))) x0) -> (forall x4, x4 :e omega -> SNoLt x0 (ap x3 x4)) -> (forall x4, x4 :e omega -> (forall x5, x5 :e x4 -> SNoLt (ap x3 x4) (ap x3 x5))) -> SNoCutP (Repl omega (ap x2)) (Repl omega (ap x3)) -> x0 = SNoCut (Repl omega (ap x2)) (Repl omega (ap x3)) -> x1)) -> x1)).
admit.
Qed.
