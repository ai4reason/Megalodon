...
Definition missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_a7a33b9fdb7d0f4fd2e300595de630c8d8347507e9641249008f0371102f5e76 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_251665af908dae3465eb1d60dfea8e5e6e0f56227efd428ed1a6d83b6ceee0b8 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3c5db6140b7224728e89f1e9c2cdec5db4ef2a8a7f721868cdad7662e6f53897 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b133a4c77978ad1cd924b0611be6161b9823f43f3d98272e610bef663dedf96f : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9090ff9160e8a0b5791a98bbdd04270cea87d79bf928c686282d5ba2dfb3df9b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6d5bef0dbb2005bdf3e81a93a03fdcfe561ae3b0b13cf49b0cf653edfc8b4339 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c929cf59f565203eacf17a08388ba1580a728af00e08b935c4735c35f3bf98d7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6971ea229b211d02990fa30f9a72a16e6fa0cb5cf0afd0617614e835f943d33c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_469fbe329c0aa7326d009de299658708b015296f3bf1bbdfd9c68d910fadcf5c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4d04496597fd76264a8cc9a34e7c87c9aa7a02664fdcdf4ab9045c9c4b2478e6 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e2486afcd075788e8f862344c3f8eb2816eef6bb51ce6dfaf0e93906469d628b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1a4fda2be7d44e4087187ce234662f0177ab02c3e536bc79340535503c3665a2 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b_e missingname_e4564ff4bb06669ef83d1a5fc147028ff3f23b1328affca13a47cf9d793f3d9c struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
