...
Theorem missingprop_0638c3b4540642ea0f15fef73263da94e2cb00310bfc6a41a9602ac5c7f1d01e : MetaCat missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp.
admit.
Qed.
...
Theorem missingprop_1a2bfedfcebcbe240c19f87c7ac2de4b6675b87e38cea400b1aa4cf15f45125f : MetaFunctor missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp (fun x0 : set => True) HomSet lam_id (fun x0 x1 x2 : set => lam_comp x0) (fun x0 : set => ap x0 Empty) (fun x0 x1 x2 : set => x2).
admit.
Qed.
...
Theorem missingprop_2f83cb50725498dcdebc099061da8039791000daff847618bf51ec04ce8e7a62 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a6f455feb1885e252b3a58f0c96b456e709fc6082fb5e73aa0c3ac0f2d697985 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7fa21afa4b65a692104293fadb656d606743abe91166b12560e3578d355bafbe : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7ec15dc1081c0bec35a11b8bbc9e3be4e9419ff73dd6a84800b2f74764d45c51 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d83e8a883247378648ea82577ea801129ed2915501d1ea10c37a71102e679f4f : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ed02700dae25b17a96433391b4e427c0165347bb38b9c79f8781eaf6cf56e53f : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_48cc55144ac3c3e4f4b1a0a8316f8cf6641207338f3fd72d2d37d1fcfe608d5b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dbd6570f69c4093b06b10c55da50d5ae2ed71c17fee312a16994c46e726959e0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f70b1c6d0acb4870356145094c3c0579168bedaf94c7a2aefb22a285667d19b9 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f75c1272b5d8f07abe9b6a306d00a8e09f16ef9d943a04706212761180d22d71 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) missingname_10b14720e230e8ddf5f0b6a250d8c3331b576763125dd3abc1a0624cfd90b4dc MagmaHom struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
