...
Definition missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (UnaryFuncHom x0 x1 x2) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_3bac6dd057c2c384e08eb10c3934ffcfce70c8697398dccb9dfffb2674a18ad4 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dd940dd80e347cfbe0d4ce67252939d83e396b553ecb1e9a808199f06937dae4 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8959ddd420b6152510b4b23f8e3115e69043ea2b58d0a2f391868ca80aa97385 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1cee88045b3c1bd06f5da0c08c7a6e04e48c97ae3edd46eceaa6446b7f07a394 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dcf8c0bd391f23dd725ad77e430aa1a9ded58e69f584cff0844919836be4fabf : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ce3d5d2c1e8d1f6c765b987236c50165be3f86075cbda9455858b033cd414c5a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4f2bc7451ea9249f3bcdab5f9f764a04c20a999a08fb8b7cd611a64c4c425ff6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bec8b5da3819f72835c3a1120721144aca0e4194b91ad85e54abc74edbfe84e1 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9139f864a8e7f4119d6e757fc4e88f980bcc847fee0ff379dd4abb136894c751 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d638e480ee13328f18e1f810f0f7c817af84c15beefce2e94d18ce691c0d848f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ae3f29f6cc7986fe0d7ca499c341de4919fd9ae323e079a768ea1dfda4637605 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_72f845fce0610766876c136acf226ec2aed680da41d0fec3b93e29278bb65f82 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_r missingname_9a9d71d727c4bd23f600a5c723fbeff7d2e07eeddeee8378ae5720d069789183 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
