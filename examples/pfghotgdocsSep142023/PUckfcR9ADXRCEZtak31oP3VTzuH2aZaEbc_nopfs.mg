...
Definition missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (MagmaHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_d89f7eece984deb34b962cdfcbcfe9e965f6ec6a1920ee3d639a353dd9a2e66a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f03f951c641d5eb3372e7cfe7663c32670246a810b3af863a1b73620ba6e9235 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_993115b3ab213249e2bf1f20960dea7d974166b83a57e5d276c4aa6622fb1633 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8a93acbc76a983cd27ecece2c5d81fd53fc42b828273a6ebf8a07e102b1e658c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_af9810813877f082cbc58b8a1dee760fdad1613e9905fe886d46e730066accb0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_65fea0dd5a77884df00364f0858170b6fa27b16c5477d06a25cbbdd7680f0a72 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_578b1cb77d6be976b9ebbefb2e5f16b45b2a33c85125d491f91bca6b933044bf : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_008ba9741f6270edf125a2ee083ee2550cebe8b86df56c8ccbd26f5d98462261 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_391b7f17f7d75e346c553f3b3a49d700d4fc751d38dc752af1de9736806e91ac : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_956303109bb1c6493b2ce30559c17e7c261e112675272862277d03e007b072d0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6bc0fb1831d81c751dcf58f8ee112a4f68d2560f869a84b634709658dc303062 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e64c8ad3f15bf999a5c90f8dbe07bf21e33117cf5dd981f91147318e2430f337 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_r_p missingname_7df6c86d2860500780d27547ab9f37c624f1bcc696f0bd75f85a3e06c87cd37f struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
