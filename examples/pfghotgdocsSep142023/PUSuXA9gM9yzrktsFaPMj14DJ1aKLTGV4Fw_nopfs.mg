...
Definition T2_Topology_buggy : set -> prop :=
 (fun x0 : set => and (struct_c x0) (unpack_c_o x0 (fun x1 : set => fun x2 : (set -> prop) -> prop => and (and (and (x2 (fun x3 : set => x3 :e x1)) (forall x3 x4 : set -> prop, x2 x3 -> x2 x4 -> x2 (fun x5 : set => and (x3 x5) (x3 x5)))) (forall x3 : (set -> prop) -> prop, (forall x4 : set -> prop, x3 x4 -> x2 x4) -> x2 (fun x4 : set => forall x5 : prop, (forall x6 : set -> prop, and (x3 x6) (x6 x4) -> x5) -> x5))) (forall x3, x3 :e x1 -> (forall x4, x4 :e x1 -> (x3 = x4 -> (forall x5 : prop, x5)) -> (forall x5 : prop, (forall x6 : set -> prop, and (x2 x6) (exactly1of2 (x6 x3) (x6 x4)) -> x5) -> x5)))))).
...
Theorem missingprop_0414e93776cfcf0e3df3d04ab85848aa5abf73c9f214ef2bcb16df3e874e631a : MetaCat T2_Topology_buggy PreContinuousHom struct_id struct_comp.
admit.
Qed.
...
Theorem missingprop_3f0ca0f188b469cad131fe75343fdaa60901b9ef853518288d24f47767061cc1 : MetaFunctor T2_Topology_buggy PreContinuousHom struct_id struct_comp (fun x0 : set => True) HomSet lam_id (fun x0 x1 x2 : set => lam_comp x0) (fun x0 : set => ap x0 Empty) (fun x0 x1 x2 : set => x2).
admit.
Qed.
...
Theorem missingprop_3cbf3efa0c188eea825b567f2bf5579627be1ce86ea23cf5d8db6a096fcc04d7 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9f97ff6d55a8c09ded25bb548861993124aeb02db15b5f98e34624a632547bf3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4b0bb6da19e9cdfa3d3671212bfd83678f8b9cc514f74e63ea03511d95bc4df8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5764cf8e1acddc763bb6ce2871c1da777717df6a222278ebc7db00a40377da77 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3eb733dc093f00d49388fe669f8a431093e1bf1512df0018619ddf72fd951e83 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_044b987dbc1accd37c599d2bef34f2ab30b11f52a05fc8d15d23a81eb512ba8b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a3914de76b919617c8b3a6387683390f51f4c6816b0ccf9322a4e61eb4b855fc : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7aa9001025147e8133f522979883695fa0fd286dcc8cb6997e4b30d39ab6f28b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4b5934adc37b1bcf86b8d52bd50a27843fe3662b4b601f7187234de0158441f2 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_88973d11f9183bb5c1c5702ee370a8fcb67965a55ac2da62a95de9b4bb709fc5 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) T2_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
