...
Definition missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (BinRelnHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_504e071d025b96d6f6cae34db6fbad10b70c1cc8192cbd9e88bc7f90d5cff78f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_810eb11f37e909b062b144dc9b4c34fd467f755d3029ee91af7886508b2ce231 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_21970bcfc5f3a888f6eb7179d61908340b1132137c6e04def278fedab62e0cae : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8ff6d1bb14239ba7f701d6588cfabf6bc6d3a0295ee7a7068ba6ab5f1c216bfe : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_76072ed36ac09d84afd3eff00009d0077c3c92e21574f0ba41b82d7a0751fd16 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_26b6ee5fbda9f52b125c2febd81fab5ecd79110c886499055754d1341109f4ec : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_88999d47c991f5b048443f911afe49caa97c29a85be984d2d04798cd3b8f8857 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5bd3f6e7d96fb2fa098db8fbe45b3fe504bc2e0079971e29ac6168e572351590 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_582b19336cf56a6956452d2751b82432bb2d91ec2d8005bdd049be5426dd291b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_585d55a169ed171899fdcffa363fcb3fd9822813159455ffc0544a6eda8c75dc : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_090af40bf5963001d5db786725a3feb90d8f0c1ec6b6986b3bcbbb4727b3ca70 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b27b131b829b0b5873d749af736f1cc4a44419f4e5097b7d943b7737f2b281ef : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_p_e_e missingname_91d2bfe2089f23b232e7b2025d6a8bd944b7a52a3418c35a85375411482fb4b9 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
