...
Definition missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (BinRelnHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_8d25551c7141bd45fb95898a705825d916e8dec46aac957c7414bf5373d39f6b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5780e316070dca10d5288087e920963c78905fb8218cddfa3b7038810f091845 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bfbc7e032590e04b39471a1bd2b6e0b1aa014ca4a4a389b7a1952a9c9902202c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9677b69f3460844e6de3b6c2b53bac0679b89664290213b644422b13a984e059 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5aa91712c3ca7e8eaae241ee550e27b854eed5545f335d26ec5d4eaa6b66bbe7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9ea2bdd75fda7e6c9de98ee32d9867c1a8af2533eb51f9557347a90bee6e97af : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cec50385812ba5d1889ba2cc1c99f4347a3b7e8ff054690f4fd12e3daeeb4eef : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_79ba6317021f49ae090a77220705d253256825dc8491ead9dda111263917013b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e2950eb22672bf73f02e816ffd7ba87117c68472835c7e9c0d65e2451c49baef : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bb3e9a2686714cc5f1c939ddaf69d119290a342ca83c8f58660d8c789bbb1075 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dd93027d02bfe31a179b0042d7e73627ab4170e09b13c050b5b364e9cbb6c8a5 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_r_e_e missingname_d231fda301e6b535985091b86fdc6d45aac6e51fc390d7ffcdf8da9265d3afc6 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
