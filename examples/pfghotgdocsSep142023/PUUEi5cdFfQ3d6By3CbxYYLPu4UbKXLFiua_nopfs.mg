...
Definition missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_85f8683e593d304d71e92ead7721f95c17664215fd9cc6eded1bb8736a5a2b90 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b09fdae6ff0119ce59fb28309530b40a4e215c32c5d393439218ef1b9186f4b1 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cb312600abf40278ef840debe4ce7d5f8806e95e61caf8f5b1785bbb34cc8744 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_002d49ef0a15bc52f39e3f3bfd20997632b0fe8cbfc182c9cff4274c728fb74d : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3774ba61bd3b2ace97ffb0b2b66abdbeda74630eebabea7e1be31cd21e536e0e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_792b49f15b2cfe0a02f026954db22480af716c5fa397a2edfbdb159e0b29ab97 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_238e8b218d7ed7f2062f97ca956b15f65c387af0aca45859d7169b91b09011d8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_743276319f2e9b59d181ba485fd048e06a94c8fb70a02d1a306b76994bff105a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_237024504ecdc59d431d5459bf522623daeb563ff9790715f497d265ed87f2d1 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_41a8943cba7947a78613836a2c4ac2cb4da5f99c44c798a908ab48d19664b90f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_de4c20de0e4815ccfd01910fdbd9e8341564dbfa03ee1c3520961f7dc50ff591 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_r_p_e missingname_8ed4ae94e5f47af8daee6dbed3c76056a5e8e45f8f63d6c1cbc782a022d19f8d struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
