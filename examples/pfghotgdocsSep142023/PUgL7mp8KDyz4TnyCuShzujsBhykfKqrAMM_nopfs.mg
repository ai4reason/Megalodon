...
Definition missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_d5db1cac61fe9480591a7651a8036240f6c953360c32b9a5f888bd63a35542fe : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_656b2800acddb2a62bc81e576c93bb192977fb81565b753bc8cbdccdc7eb9efd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f17c08e85db1d638fb6eb42c03d37dbc53556bdfbe0e4455b667b8b9cbc86738 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ce90e1ab118e7a14051159d52022a056b7d807cb15518b51c053875a0ed69881 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f297a299b713610b9fb5ed89db28c3480d802797a5da7ba380045818ec7193e1 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c2caca8ee4768965f0b369cc5a05cf0be41c93727840b4730158ec43ce0e425e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_343022d4f6984b5531ffa3539716344903f7c02d72cbe2cdf96fe16ea265f671 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7bf55540379c2c12791df662c1de5585be3499a57bf180cf84d77639b2d1ac02 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e91335eb91fe87e5de9ff508d004a1a15538c119b1ae1661a555eed3a9c36229 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bc934d82b8ca2356e3bb0fde04c36a327b47ec3fff37f4ffce1cd7e797a11d5d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_04ebbce1b32afc75b4a6707088238cb5db9ca6aa7fbae508cac6e12446cec186 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_p missingname_a703c20e04487348adde682801cd826d7b67ce1da950be2bbee8a965b7669d9b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
