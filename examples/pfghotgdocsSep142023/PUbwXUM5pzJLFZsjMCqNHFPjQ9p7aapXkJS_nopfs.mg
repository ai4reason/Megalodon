...
Definition missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_886b00ec829da9efcceb1ab7ec3319e72efbfe5680338845c9520f742b50857d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_366ccd40177af4c3f1c319e233b7624cff78f7f1e9439b74568b921bd88fdf36 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3a189ada196fb96a78c7b5abd2ebb2b3ce2b9585c9cb268764995ec74d003559 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c4b5bbf2b03fa93269bd90d2dff421c8e2a65d13907421c54336eb043982af44 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5b397730f9d57246b157512c43fbb981832257e08b7bff8e11bdd237f0269cb9 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_11531fa466f1966efe348311410e729f02e7c5eabef1d97bf4a1bab812e38851 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e2cab535042f198e8f147477a2cd1199797eba5cc65c9741cd4a7837df5b6fc9 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8c81ef8769727412bf6fcfa5e8c565e1f1bf4d91c420065fcaa3ad348af5fef2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b6dfe5ca9f45a8b529a9fcac867b22f4cdddf46308a3ea5d3499327054766d69 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e4f7a5c33332452720d171352e0b25cd9ff6a843708c10ab25d70566c0107cd0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6bcd61027044ec6c4e51f5c9e9033ffe0ebd7c96d881bc6336cbbe519176b17d : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_p_p missingname_cefbfe9bb304fa99d55fc81f12e59550307d2e24a701de7c29d04edd679e01b3 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
