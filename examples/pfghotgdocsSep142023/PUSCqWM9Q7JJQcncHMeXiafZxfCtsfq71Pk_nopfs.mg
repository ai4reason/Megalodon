...
Definition missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (MagmaHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_ee8035b281ec5c175c147f88d26535a32dbecf11cc8012af1fc7a90ee4759839 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_40130248d5bf083725a3163f8aeb9f780f3486a4d252eb1c8fa35ccb792ef4cc : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_be0b1e350b3c3bccbce57d23f289afa7712f0f29c3bc39458cf051658a2b6041 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_944b97f26dba60482c5616ccdff59dbdae6b045ae2dc083ed265076e08d08c9c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7c15ac64b5c551d636b9f546c922d1d592b17143b0339358144204bd489c75d6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3fe7e86f280ae5a1f4d8775a68fe202c29227261e99b3a1c3b18c821a3b37bb0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a440200e101b4dd5ae1a8e6ac4c09eb14b5cb649c88498e8344f5545aa48f64f : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7ba7f96de8e0cc6529daa477cdc794e27cffc8a8bfe70e8ac53a17ae836815ab : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_04590d92ec252ce33a9a8623d76df114ced27841339bc23506f82939fbb4c8c5 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_275b9a8ad4650d7297c1c87dee4796a9321bb7ae0eec8cef5a0934b6d794c38b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0d08a936af738d3db71bef93170a79a645a5e26356cf78c1519173da21d950c9 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_63404de901c3635bc778949e157486acfe70c9829563b5e6d8d71c6d9ca0ad36 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_u_r missingname_14e51a2f804d3eec13eed4215ceb9fc2b981ee62d1ca92fbe869423c8b2f4bc1 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
