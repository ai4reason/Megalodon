...
Definition missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)).
...
Theorem missingprop_ecd450e66d0e71ea280adebcebeaa32fa519504f52eb3169ddbcfb56782719c3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d7e2e1e9aa43288521e617408b6f1d4b00a80e6f2cc2110d8ef4132bf4b4d1bf : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9b96e9a4d6e3b8e47559705d6a2ef4518a92841cd616f1dbe5ae215740eceb49 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4d0bb46530a42e1fe7db449c56d9737ea2d08da4157a71a3709d0f9c34e87168 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0efd06d22d966f81e54d2de641e1ea34670703f0d95fadbe55f8ae1464af047a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a5318090e1fdb4b26469c994229fbef7377d49cb4e9039b949cc231c0959e5c8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_48977410f1d7bff7cee7b1179221e6eeab12f9ba26dced9cd75a4dfb1b42b66a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1f26936aaf625bc12ee576d0826f6ec053a252a1a002190b376e2a254ffe65ba : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_eb1b0f1e9e3111b700d650c4c3c9119adc8bdb7467296f638db83d01c05b903b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8d21b62c1541527b1fc4abc84bd2256550cdc50b66462c9ffaa7acbd847bb14b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b3f29f2595a7218e7efe45de3871191956b3f9a62921e96b0d62748e5ef0b0e2 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_630fb297a16be47a095d3a81a2155fe01966fe729739e01aeac3536b8ad304fd : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b missingname_ff52b84f06c4169839d401a4842a0fdbea232bd650d81c541585f05ee1bca070 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
