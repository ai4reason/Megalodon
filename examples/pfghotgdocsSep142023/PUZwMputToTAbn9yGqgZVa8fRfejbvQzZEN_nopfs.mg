...
Definition missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_627ed5eeace9bd45a61a2fcc4c2acb715ed2b45b9800181672a5ef044073af55 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ef9db8000a149d16fdd2ed044130ed65f26d439f249dd378e2aca31c508fa301 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_16ba531694f4785111427e4b28ff8ad3a2519fb7bc653d69d9e0289fed4b3dc3 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_27e6eb12582b4153571b9ff331e2a3867238a256e171ac54ecffa5a0a198d523 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_70cc14cb9ff9de631d8cac18c05443b856d2a0b97d1b7aaef029c50391223621 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cbf499c645972ca236e0375501c9c2a9ed7dc9163674a8fa6d8a5353be3d6c4a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_aa61badcdf029ca0d48007c9b3beb27fb220bdc57701af8bcdb92d68d3e3fa66 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4355b7f438217cfc77340468ddcdd4587af9c80f0c8c8375b2d5ed6efdc29a3d : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9625476d7d87caa27344c56f032e798728cfc373e8cbb24d6dc97f04fd261522 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a520c6bf4998a13646b4b4044838a3bc6d18a74bda376e24f1166115eb567a7a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_168ad7498a55644a67e6b63b669fa943e254a8c771d9d0939b3792f3d097486d : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_p_e_e missingname_aced6ef3c27edffd43df4f9e1cb562d55183c42884b8eec339bccd2903a2bd8a struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
