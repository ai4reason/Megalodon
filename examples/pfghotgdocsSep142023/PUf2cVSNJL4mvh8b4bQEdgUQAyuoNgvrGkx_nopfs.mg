...
Definition missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_526312193b47db1dca30ff4db1725c15adc11d45a54a0d128bbf37f67eca3f82 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8fafd89be330d88ebfab064b8b5cc80ab22541c5b067d94e7cec1e2f044aec5f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f87aaaf5531cabd04d2ef0703c4593b0707ff2de4d89d76c6d66c389a48b1ad9 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_15b87ced10a07d57b3dff60f2d30d2f352dcdcf8cad59ce29168d9e14635d617 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8914d2c451017e35b0c1ca86dc081da5706f651d80fb8e0b144bae7aad7e364b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_68f13411a19a62ee1057cadb23c072da1e728fc9f2cc6af97b7d222833127532 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1bfe46322ed646f735b1782fccf9c722817da5c30a26e1a8b0f5744971394d81 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5b5ecdbe6c99b329cfd629e1b9fb769ebe2fd2ae6807035756154ed5a656e445 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cab14cf6363063cd0b9657c4800f94c495dd742d6da6266525d622f84fe89933 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_646f86937186a2a6f9dd763dd604a8e65d7abb806d5744975a8d08778be7ccdb : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_809eaa4a455d5139f85909ab21b5ce1c42623abce017ec3ec3962798cd97980e : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_r_p_e missingname_7683df04de5d780c8d0ef28a4ee34b1f9d5d68ce0eab25180dbe969b635a4bb6 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
