...
Definition missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_ddb9a115bacd9c755e1768fde3fb3ac85a431f1bb3a1c4331e6d1822d14ca66b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_13ce520da9c3f1fac8c568cbc37855f77614aeda0dbe8e2b7ded6da1c4165bb1 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fac50ef8a7edf2e4219194ed0e655db6256205896aafb72cc064277d72fa54d2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_21e63eb5619c08bd26d3b8c9b1de4e016e6c52cff43baa5c299934fc62772e20 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_aec09d8f7be681f84bb7d1657c69fc80d24d371d89f17ab856d80e326877e70d : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a4bf712811cff2f5895333e6b00fd5cbc40a4beba515c71e25f273eb00f134fa : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8edb3f84e05ab6cba67690de69c49b78c6d968d612577e1a0b30bf3c35ab7818 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ff280bca5026553bcca718e325919e62a59d173e0db38291d86ece8c58e79a17 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4caf6572036a9a9ca84ae94b41892086652c6061a5ba2366b148b4593c87c19f : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_99a1473271132a5094a3eb8569ffc878f460f832a983fb33d2b2a1ed22ae8d4c : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d387da05e896f8c0fe2f17f0429b727e23a4a0733c605491d9405d707164c1dc : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_r_p missingname_1becd562f1039cc056509077c069b81e9344e2c1c3e93a573110a70aaa067bfe struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
