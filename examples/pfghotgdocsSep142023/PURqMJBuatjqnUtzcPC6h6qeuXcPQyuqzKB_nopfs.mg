...
Definition missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (MagmaHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_ef4f9c1530c7dca8d586b426b3b7cb09ba8e6b524ff2ff4090d00bf12d5e7cab : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_eb91b2977317353eb36bfe5749aaf4075dfd527efca493044510afdf8c69b465 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d36860e40541e401fb5d0cbd5b7cdd656da990d7ce40b0b57be0e12bfdfbe0bf : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_00e1b55aed17168cdcaf47aba48b4a591ac0e4c98e39f06f4f16c274b9c91bfb : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_94f5ff44b8357234724fcb84da7b45eba90a93caece9c0f19927c1f96b817454 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_74912d8a940e6bf108a186431358646f4fe90348ef6bb659cabeef8234e4b315 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a36a6f2b498e3d67a0e481157aafb291be02989a752c01a239a262840e0d3877 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_80aaebcf1ec9f4b6f8b9e44f0f48a2855c9cb0eaf765a5ece37709de47f2f614 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e8c78289d72fc8cdf14128cb725e7540831068d16facb41396c9d55bc196735d : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2175b75bfb475f87fb667a05d4b88c69010f39804cedc67ebdf2166aa72867a5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dd4c5e947c8ed4ebbb0a651ee8658822dd4a0b42d6d0607d69dcc8ba4e944089 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_b_p missingname_0d7c142ddb4c04af730834e0f7580e876f6419b8082c9cce5743293fc082b785 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
