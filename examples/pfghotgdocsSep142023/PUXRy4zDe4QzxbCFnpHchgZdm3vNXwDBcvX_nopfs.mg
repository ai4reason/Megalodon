...
Definition missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (MagmaHom x0 x1 x2) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_c5397407c860d8eb447c87bbf17c28fe2c6cea3535c7728f2a4f7eeb175e51cc : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3f6e8cd965d5e5b2c5c7d69000154544b924db51150877d698a75cfab18cbe5f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_46686df70cd582fd8cb897c3a9e901c100c855b567a99cd2815fa081b1518ae7 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f232c15b167c3dc3864d1ba3e70d68e64a1ee0d74f2cd5a48b604579679fc302 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ba3305a3d4d10a72d270243c5934844bcabcd45d3f9d00f15c6e24fb556de257 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_92f18f4c92a277da5353ad7073991ade63558c9eeca062e20479bf1ee3258d05 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1ca20bf621cb8c0350244d5df585c89364c6382c1d9debd405ab9df141b63a82 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e1730f611d1361194dbbac69a3c7dbf6b97a96b3b02c525fac061f7e9da0e8c4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b110089640805d28a2a9bae84029ec0a4a4198e6d663d0c4fcc75101d69c299f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c358eda6b3c277f81e079e283b8c700979df8c3a52ccf0ab0df5cd2fdf11116d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f03842f73a424e766d05a040ebd9e3dba19165a1bb8acab7752f2580bcb95608 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_p_e missingname_6d16f0b957874c6248e1b8259f90c6cf4508d2b64f6a59a527501151a18450ed struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
