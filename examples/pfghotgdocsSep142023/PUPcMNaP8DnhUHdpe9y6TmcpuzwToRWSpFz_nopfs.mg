...
Definition Hausdorff_Topology_buggy : set -> prop :=
 (fun x0 : set => and (struct_c x0) (unpack_c_o x0 (fun x1 : set => fun x2 : (set -> prop) -> prop => and (and (and (x2 (fun x3 : set => x3 :e x1)) (forall x3 x4 : set -> prop, x2 x3 -> x2 x4 -> x2 (fun x5 : set => and (x3 x5) (x3 x5)))) (forall x3 : (set -> prop) -> prop, (forall x4 : set -> prop, x3 x4 -> x2 x4) -> x2 (fun x4 : set => forall x5 : prop, (forall x6 : set -> prop, and (x3 x6) (x6 x4) -> x5) -> x5))) (forall x3, x3 :e x1 -> (forall x4, x4 :e x1 -> (x3 = x4 -> (forall x5 : prop, x5)) -> (forall x5 : prop, (forall x6 : set -> prop, (forall x7 : prop, (forall x8 : set -> prop, and (and (and (and (x2 x6) (x2 x8)) (x6 x3)) (x8 x4)) (forall x9, x6 x9 -> not (x8 x9)) -> x7) -> x7) -> x5) -> x5)))))).
...
Theorem missingprop_39da154bc3c55f0b5683592819726b32b1d6097c14192fac314f63b8c3b3c06f : MetaCat Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp.
admit.
Qed.
...
Theorem missingprop_c97e7bfb7b8a313e10e5df27342566499ad835ceae6570fd2766ee51266d58eb : MetaFunctor Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp (fun x0 : set => True) HomSet lam_id (fun x0 x1 x2 : set => lam_comp x0) (fun x0 : set => ap x0 Empty) (fun x0 x1 x2 : set => x2).
admit.
Qed.
...
Theorem missingprop_c6af43bcf67dfa4e90cd86e5f92c75f165ec6f6fca4be6eaee6a643dce3cd6b5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3d6cf9c1b2a129086f3f881713765ca60dd576c53505700793f4f025f04a940a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5b67a900b539a521e1b1a346d06f7b0f6881a8a6394e6071449e09d1794502db : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_defa7fa4f804084cc266f0c80bc4f93ce7b979dfd4dd3872ae5be5fce29f67bc : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a9b13a959190ec13911b6e69aafd66dfa55b4150e929aa519b603d0749ef679d : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1130aaadeb43f60bc8238b59d5344e954e78aee833f3b83671d21ae2e56b2d07 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_30160c23a0d1e48290ec90bba7e66931edbba7ff212f564e7cb9d971f7356eb2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_adf23464b2ec9751682d7821155579399ec8c4aa1cfd12fe4c82eb47747e2003 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_568d6e2c83d1ae8cdada0197745b2c1ee4d2f9b448d60e2a4f4e0f4479631583 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1f0fb0fd9f3a2cc39f10c4e740d4686cc553bd559a371c1254d6465b493d10cd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f01e4aa161f07b2deb0a166a32db079414a2152ceadf3c86f9c36b4f0455296d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_14e059150e8f2155cdb65fb7794938f27fbd5152eb0a65017fd072c4dce71395 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) Hausdorff_Topology_buggy PreContinuousHom struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
