...
Definition missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_b2fec4dd3863b6e16a93a9e46dfc1cf101c946857e551c0d541dbab7398b8350 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c27226758788a3268a775d8d6d13b7a8d807896c6ae08a76677e8c69118265a3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_46b8a7e02cf01f89bba1b19bcf59572ebaf2dc3c75acb623091d6e398d5b6ea6 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5ee46402d1083a8b443ea83c786a33766b59b416dde37abaf4bdb165c5e045c0 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bdee9b4b181baaecb4af76cb03b7d729f8c4605eba0d722ef4657e52c253a5d8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_be44b14edf99b7ca12c71313fca029a9655c456046db616be99fb5cb327edd76 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f8efaea42a1d37d653c0608a96f7ebf19afe56e3e2bee160503f2039bd7ae39a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6cda198b56b538779cdb993454f935fc35c7163bb5a2030418842cf1673ccfc6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_35acbb11692b1bbab66b19242d4034fa52eea7b7a84c08bc6e2c1ddc4cef3f09 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2a62e8f45d411dbcfc2a58ff163a72f98aa110b835c513e977ed02cc86e902e5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4d022f367a2bdb677eff69ed97379a9afe6d33cdafe62a9877733d4085dda571 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_002cd9ad04885f60a384f3c4d31fdd08c313fd5d41f10cc88fc8b224df118528 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_p_e missingname_540eace6750b2d52bc38ba50b70790de9bf702a25ead4774b02962ee7a168a46 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
