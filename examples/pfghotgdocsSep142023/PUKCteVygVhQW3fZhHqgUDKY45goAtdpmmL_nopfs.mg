...
Definition missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (PtdSetHom x0 x1 x2) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_1d895cb36859bca48b229ee8f66aa6d4b8ad3222141562b9f403b87b2ff6d056 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e7ce2623daac31ed18a31594b77aefcdf4dba74abd241b68c2c2845b4687dcb3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a90a858e0097ecbace660054a95491e64250bdd98d4a6eaeb5d181131984c448 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ecc56e2a2b5ca17277a64bf0fb0ce22a1e9d2f13040c54aa08a303aacba9d873 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d7e9d718b4c075033a13e6c2b9b215adf6cf9d73e1f6dab68f7df8f72f17ef5b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_df97444ff6ff78284391ff3e8e5997905391292331483f66542b3e3a8c5b4cc4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f948fce693334c260919c0549655b3927b5f095eb3cfd3a89706c9e145dd20ec : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7420ca385b3beb9b750e06638c3febefae116502816d132690cfe92b74b7a5c8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_534b680a91bd73d3d7f246f0673334e56a4f1c553c5920cdf88dd527b0c0c6d4 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_34988dd4cec80eaa304c941aedace0bb143db519535fe283d0ca29d63253e498 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b5917edd3d70719d0154557e00b5975ad74369469f5f2f97338b0112953dcbce : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_97494d6d06537b9b87c1dd737f372ec7e8f25d1d3a0e317d08bab4ef4b760c90 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_e_e missingname_1cc0695cdd0b9ce154ae8f2873ffb7b0496271ff37b429daf8cbc76ade85bd79 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
