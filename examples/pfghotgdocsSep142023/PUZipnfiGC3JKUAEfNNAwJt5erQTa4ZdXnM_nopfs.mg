...
Definition missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_44733f67dcc29dea0978a491a850073e4d5949bd974c9063d6b2f00b940e8cca : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_001e1d1891a66285f30374ce425f08347192f60c634eae961d67c8a59d306e5c : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9b453242c5cc04c6a212f757cf03c04f87d9161b8a3d105561d08aa371049282 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6faea87e589049f6a0a3f09f407703c948b4b7160ab2fd5a253d435ccfc9060c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d0f8f817aa4bf6cab4fec0c434fdd38b21c129e514dbf02ce089650e945fca38 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b43eb6f1e82944b8f74805cd8652999ba7491ec627c61e9d84ca874a4bfb67f0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_86ed58fa31a4e8b3c5bd2cf22d07cbd7eb0e55f3cad415e1a594ee44cc0b2eb1 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c9365605d615e953b124661d2993635026f29712636dc7650047185623e76405 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0046657eaa35747ea1e6a3e7706e5dd3438fa75c52d8a11a3a4ecfc70fc1dc67 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4be6ac4d8404bf376794d3a464f463d06fccc58095d95535597742a254eba4aa : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_191d3f90504eac2cf71f3cd439e87ca7a6db3b6de9fd0ba49ca93d2b2dad4e60 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_u_p missingname_73b32ffbaf41c3d5ef58a462c63da27fd8d24c5d862ae5049a813bf736805a3e struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
