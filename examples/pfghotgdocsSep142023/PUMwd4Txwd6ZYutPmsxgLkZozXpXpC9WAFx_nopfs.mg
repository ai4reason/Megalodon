...
Definition missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_90dab7c8c68dcc2ebd9351489e8dec66330d2944fbd829baf1cef7b5c0152bca : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6f14f6ce9777e39aa54ba4e5d50b1d6012a243c90f3571b80a9527d481e7c60f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9ef6c917789c1f86f6b1526c6eb44be0241ffa7a6f3f79576cc6da096da25624 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_be37c91325a8ef243217d073457b652824cc31d99e4738587f25ca7cd26013be : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7b38298e0064528773c853a5069167424ede760ae28b86124c8e43c692213f49 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0e8a325b1ac81941eb8c1646e2ab94763883f6e2236e78fbc1e5345a7561adca : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9f5a61f3ebd0eb812df8bc087203e455af32cbf47f3c739c28133f1743996a72 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_24ea36dcbe70c76ae63298bad875d9a71602f38a7a899c864b46d91ab0d60fc4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_437aaf538b3854942a642c4de4e9955aca37a5932cf5d8ecdbd852f7920ef4d9 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ff5eca7e291f1e1484396763286d6bcdb4eacf75c26eee41a910b2638c4e296f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f024cfcf4bd7375db462aa8586ea3c4a336d073e34b9036bc532be9544668b19 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e1f8cfb4f6b530a10b8c0dd01add571931a2279b2da8dcbbae4187b49f96fc35 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_e_e missingname_266931d9f6931f85136c4752b1281d9ac78faf5dd8a4f25c674cfa8d17e2bfec struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
