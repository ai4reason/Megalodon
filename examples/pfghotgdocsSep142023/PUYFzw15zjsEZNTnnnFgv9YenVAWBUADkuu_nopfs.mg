...
Definition missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_4fb191bf431d5a5f6d094999363b6d287220c34c101b5f31714a66aa0462a85f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f3b40b105bcd30d400b29ac8a029206c7658b42cd996000fe9211c25ddd9653d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dc541ffabe5f4cbf405c2faa4815200639ff7ba3af133d330f0daa58d5a503c6 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e182d2163f8ba454053aaa72b5de747aff4431ce5fbdef7eb6a474143b973572 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9f583ab853affad7bdadd25db0d779efc36555de209b995cdf602a86560ac3d0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_38826bb1fd4460fc88aab76d8b84831bed94f0b61533b199a544ec6e60859b28 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e79a5d9342e0038abc5a9b748f448fea8477b7b70cb98a44775e21116c45a8ef : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bd12a50af143b96b54acfa163d111b03a19ba26edfa257faa69b3ffc6dc117c7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_498c5c0c07bfc3682d8b24630d481253b70634a9db38ec3178650d5172313dd4 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5ca38e2b372183a468ea7e6bdf5b4042998df8d68d14eee503337ac613a98074 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_63e2431b78f4915c81dce73d476bcecdd8e7218838b3d55d1acf5b864a7d3a63 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_802cf19a712e91993654dcb486d5568bd044bc28efa95d0b8cec32f097eef5ab : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b_u_p missingname_902eea0379bfb51908db38e272a60459b123ddf8f351dcba42405439920d71a5 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
