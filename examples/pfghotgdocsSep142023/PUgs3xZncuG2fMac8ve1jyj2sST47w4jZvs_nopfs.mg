...
Definition missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_ddd9a30f7f6f815b4baa4918094c2ed57b5a16cfcf452da910bb56b759dd6849 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7a778ddb000908048e3f8d23582c99a9b0f1bd415311a4ac5655eca7a70d770d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_086eb847d55879c72e4dd071b9c9d361f00f42d65ef7c95dab88a5d1eeb25083 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2d0895d7145a78d4b92d48d3d503c41c5187680ba3c7fa9736060c23d205b34b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e3a8b48e7ae356c55e11366f263bab6430c5943a76315a6a650f3c6db13c55d0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ebd475a424aa461e20f118e200f81ecb697eba099c511d4c1c4449d31339c0d9 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_289aa7522a3af6c0700eceb0a99dfa07b788f4d5bcc2e9e0f1c1fdbbfd624eb7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ca369c7b71c9b6ceab16175a80a35f359174b43d20669dd25747ce18e444f2fa : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e1f7cb3edf2f8734590ba60b9768ed64588cd56fc5da0921ea6b717897611886 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_233f2040cca603ca67a48297f14dda5e0c1b854efb63fd71a63aaaa4691da2a3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bf9ef43dab2d497423978c9de47e38b67c038286a3a7009e402381d60e82d43a : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b_u_r missingname_880a885861b65e295e739e63167e29aec85cfc4dd50c7e5d6dd1c613934d78b9 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
