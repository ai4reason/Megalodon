...
Definition missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (UnaryFuncHom x0 x1 x2) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_41475985dd6761e5863fb5415d82ea36c5363671be45e32b91fefa12d7f0ecad : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d135294324209e3bea215ed6acf9035021a7de382b5bf2c1124b5764787fe4de : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8d8a9e9c30c0320df2ca829fbadeb09768d4287b72ee2d32a368acc9ac4bce16 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bce83ed6ba9942a8329ea53c2ace255dd1ebe1d470781e399e5f88536ba340cd : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1ab27fe2292e27d6f78f187daaf0fd5f0424a63565c0f75396e32bb0451c4a2b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_593fc3cc53a2ca1468733973bd64e3891e53196c8a4473e1148aaa0d3d221984 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_58e78ba6c7a103126aaaa703acd74c704ac487d55b98357012aea327f940b5bf : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6a522ae0a0155bb67c7e5d9967769f876029e0c3ef8eaae469e9d266b27735be : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_06533678d2d02dea1c1169880aff3740d4a60521362d9dc690667542fdd58124 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d8284dfea23075d0db1dab3920725677c9535f787e1753465a79592a3edbc1b6 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8d5975100b7fa14100378324fe6a7fd00d772c2bead2a1071c99bbd8db9a2bb5 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_p missingname_32ee5a2d608b8c2a2a1003ee70ea1fe56d0f3e6ee055afc9866c314947a83dfd struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
