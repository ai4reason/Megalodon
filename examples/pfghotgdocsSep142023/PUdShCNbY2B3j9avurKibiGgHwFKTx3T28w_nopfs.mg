...
Definition missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (MagmaHom x0 x1 x2) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_325721db31667138af3afbdf921e07f35c38df95f3b584361e1f3645a9855fdf : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d6a1c2f881f90be0f239c972f867a41b7e0d0730727512d2f8e79bd1619e2032 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d6eacc40f30cb81a3b68b2d47dd82cea1f0ef9857dc5300814954f02f9031799 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_08cefbecfdeebddba163a682656e6ded95652b2c58cf404e626a450ed7f0142b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2918e9dbdf726b68bb66e3fd9d6cc0dc20253d1c039c436c615def9f56b12da1 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_61f72bc0f2f12e053190912deb5245213c1a2b83f522ddff1170290d06f9d3c5 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_27dce9162564cfa072d5f577e3b00f467891abf9ce721a2fa4ed7fe227a93a0a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_76e5e3a7f1f73dfd50b74292b8221667c3e98288340d8a047230a6cd106c3ae7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1ebf6f8d5aa8482f56dedde8cbbbcbc4e218ff7b2bd66f8e0b0552f92a346912 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cd119981ece3ebc4ace8ae982317d152337ba3d7fcb14daef6041e1a940d8e0f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8bd77ded59a5bdd86694e9c90111e0ec1bbfea7441c8528a16b85009b8f69a4c : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_19cebf292c0d20844dd61724b6af0fd46979f1c2d9ffcd085b5240c04367a363 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_e missingname_2ccad502a7625254d38b565555927725a1f6e8b6db6310701bdd043c3ebf776d struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
