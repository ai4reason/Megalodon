...
Definition missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)).
...
Theorem missingprop_9aa49223df1c8dc79fa85bf012615a6a3b08208694c94566b300298924dfc073 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_57c6a7a378fdffb1ba3ce6882f7b9ac6ce520fbef67eb65f03f00dbea7a1bad2 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2ab37937b9df545fa63e3a1382fd341ef7642359070848b69c00b14c07683af5 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_06af5950a32c5aa9e19fc9934fc6199f7fb3adf49887a3c9f9ea89bf82169e79 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_47fa6a4d61dc8954699136fa0601017924e046430ef5ccd41436f12e178f19fe : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5086412861bc17423c5931c6222b403db0c9db2b3a98b02e113dcfda946324bb : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_306b27ae8dc10e1a7bd2c392f68700db32cb4caf93b5584a1f31af351f1256a4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_06a979ea0870f1859062e574e884fd360fb866730d74f364fa04ab7ab1b005e2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b456622f2dd1e9be05511a1a23e2c0cea647f2d898f52ac195b01c6667b1e0f2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bd83531ec045aa9ca630ae4b977eff378433291f39938c60a43e3733d0a5aaf4 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bd2d29aeda66a05300619b27d549e3600787449f9dd56bea0c3417f0b47543ee : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b missingname_9d1bdaf6bcd0809970c185f5fe1477bc57ce874bb8cef81fa6ef6b9c7805a3b2 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
