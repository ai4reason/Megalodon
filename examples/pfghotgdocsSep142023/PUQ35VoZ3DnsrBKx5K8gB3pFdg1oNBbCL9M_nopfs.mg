...
Definition missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (MagmaHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_cfabbdb782494ac731ea8c4da5f64019facc61125614bbf2f69462ba827ff6b4 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_aa243bdb690b43c1b1098ee9a3d86fbdd6faeddf7e87d1ae7693dee54c6260fa : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c9a3e40550e5301951580a1e2d5993197c55d44c90970506580134fe6ef1ebd1 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_77bd2a5db40761cc0aca04aebd0ce6dfbf707e4fd68a03e0eaf05d69a301332a : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_39f69d6850304e9edd91df1879e3a3976fd112ca999f1a796cc9796f9e09e945 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_abc4eeaf983672947e2436852b8e593f6352b82fb470caf56fafa5ead09aa662 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_652ad458bc6825993d793d6b7a462f36d3df27e6fd37a12568896fd59a571295 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ecbfd932e0f576cf06fe5450b062a35f6fdf9bdc1b029ceb97f19bd9ced9ad28 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_51252163c8e41da45c258df0255db5ef0233f33ddaf8c2cd019f2e24927dced8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7e72bc345bf94ff3aac3660f125ace9f3255bf2355b09fac513a9bf0c548b6db : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f5ae476bfabe2fbeeae587530058adedbf4ae6e3867c3ad53cd6bc43f72ec784 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_b_r missingname_f0da000938d5cdd814b8c41163e32ae0a0694c5697e43bbc3e68f7edb2dd1a40 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
