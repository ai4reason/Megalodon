...
Definition missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (UnaryPredHom x0 x1 x2) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_97361e554fb108ab28f11678f8341aa8e4551a8bc08df358bdb1f3be2a56d669 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_101e815117d741ec9627269db7433b836aed1a60099424a9a6d3b46c021ad74a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_72bdcedced3a0ce39e269d9ccab24beda991e2fe7ff2b7ec0b070a92de6494bf : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_652e64ae85c1b136e6da2753108fff12dcd8d07efc2e7e01b831b189c2d30f3b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3a905c6133a9b5465e1b1b1dd27bceab0b6084800fa8ad42132eca00b2623a76 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fbe4b47db8ad9e4a09f86fa936be52614957cd219b82173763ce96895156df13 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_407f6d3255d749b6f14aa90a9f5b4861e261bd74c0b3209e3af75170e0c65ded : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8e1f6fbb59dcaa218bff08aff83f67485039dd081ae681b3488f9986a1cae57c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_480252461cc869f63f6ebbcf1ee9192f9ac01c953ec4fbeaa9d78924547ef951 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_148782c49b59836a4a7768d98613c739da509f74f8621586caede6f88df3afa5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7873d4fb59fd83465d8e1019902e6edf41327967cc108fca194f379816e2cd45 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_15023453e0631c287e132b84381c4a87dc9114a7ffe3775b82c4aac672399ff0 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_p_p missingname_222ca07cafe68c569a91220d4b8633701d21c219fcbdfd6263ff0642cfeee94b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
