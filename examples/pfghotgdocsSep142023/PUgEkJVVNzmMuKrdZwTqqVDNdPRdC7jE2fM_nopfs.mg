...
Definition missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)).
...
Theorem missingprop_c00890cfbb0591074445e4f5cb9c5fdba4b87d6fc06e30c92457030906201405 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_df874444a8c2b441946acadb2c7015b0cff7eb5c1838128cc75c7b37ea942a19 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f31f55d16c9dd141331866b8df02272916bd0b7c94cc5d1466ab6906179c11fb : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cd5cecf44c3353b8e3c43d0f728f157f76a9c6daf8f5dff07138fe536b48ff6a : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7f9704f4a7dcaf66a0165b8b558c331ba741feb162c5b60068b21ddab2341f0e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_de595a2cc8470b55c3eb52842dd2b959cf727f3ff0a7c011fb61b88cc4020d0b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d0527292b636554f94a820932afb8e9a9562f7d280b4c51eda961e5836722f6e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3467a14408bec9b548ee949a23d2bd4dd22ef3763ffabd233b70078e71ff23a5 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8ad6219c20b2d0ece160ce86050e7d54b616cd1c88b232499138f6d715eb0c23 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_488972b632ce4bff01548cf479733fbec9a5b7d82f835863651619c8baa93984 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a545705cb302805da29d95a1a5fac1418a5e7aa6a3393d939cc52b1546cf8bb9 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u missingname_c3bc092f49a316b90692fdf87b247dca108563c30b698c8fd2c2b329a4439712 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
