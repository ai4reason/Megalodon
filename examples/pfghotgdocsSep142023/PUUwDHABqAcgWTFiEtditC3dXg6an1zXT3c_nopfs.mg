...
Definition missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (UnaryFuncHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_168a2b79d6c23d7c40407065b24471efc60e5f0ba84f6abef8701c14548ebed9 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_77554680c8f7e540a155fb2b7cd7e1d3a2b84fdc24b924aeff8d8aae762f58c5 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d214248e575ca5c541ad33b8dd0f47a6d83e966c14048fac1543ca43dc580cec : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cc664a911616036a2f2374c630ffd96bfdf1c5a8c803295b0bcc162c51e8f112 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1f13e611e246ef190af8ce5a5b1ecf09ec071656c5f7a3f00eb732165e33bc3b : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_206157479edb8c95e632eb9cc971f1b717fb50892dd7c10414d58392f1f7398a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f97a00e0c65f0fb0f0ddd9c40cfc1aa6d2c55dd4d318e2f311cfc66d97a77c89 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0f00e16cdb3f54f8bedffcbb9361fa45873bdbe13fe82a8bd6b72b71569432d0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e7a40d28e87c7d59b74c8d0768def26557dc392ffbe7246bd5594cc887610716 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_17a8f25abb5e47eda2f4ffe5026c11f2e273fd9bb95f73ea438bb7a9476fc41d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e6d7d5773d86dce3e181845417ac9ce7ed2f5cf0c0aa08b3434444558b26b51d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d4325e36b37c6a2066c4eebfe4d075fba5aba56a5f47a8110708e8af7db4043c : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_r_p missingname_eacfbcfde11f3307f9707d49d637c4082ced3a67d559599a466fedbc9d079711 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
