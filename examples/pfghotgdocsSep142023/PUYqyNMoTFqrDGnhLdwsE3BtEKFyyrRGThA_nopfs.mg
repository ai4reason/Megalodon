...
Definition missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (MagmaHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_d649ac42e74eb81f38c6e45389e9eb570ef05e83b317facd0e788a76fe0c7b6d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3e9bea03033ae912a480dc108fd47d4656f827e009b9b2f2b7a79e07b3af838a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_efaf7dfa71713bbbeea69614926a9642bac1adf28c39c61b0db3783a6f6a6e8a : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_046e5d450b490e653d5fa47053bade0c957ab80567f4ecd6daaa5206bdbaf008 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2dd0703c14323e49530cca5670726f3002eb2e981a3400d4c8f330e78ac95c82 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_36bc741643cb0e488f775d0cd1794583211aaa1ed36eff40ecc526af39809874 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a97098b2cbc84c75c17d98f9663838a1ba9b9f1fdf003e6ffb76e08d9b5c8af8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4d78e73beded42ca00009296e979f1e69b88020a520081894c78fe1672f3480d : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0a41b13d3f7d82a55ec7e0f6937bee6139b305d5285450f3d1aae17abddcfc28 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f99d31af9e78c0532a53cebc7d189a017139f64dc225c7442a1d54cc75c93810 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_db772c0c203a34abdf8476b42ad1f707a7095289c9183409d743c70a050b038a : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_u_e missingname_1bf94767a5f348503bd70a6f69b215d39a4e41554b49c9b1da748a28f9d373b3 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
