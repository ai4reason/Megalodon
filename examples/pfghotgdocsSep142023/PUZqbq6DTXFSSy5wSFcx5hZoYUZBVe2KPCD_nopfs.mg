...
Definition missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_086b8cec3522bcfbbe059852bff692cde9493d8ccafd7e5bca68a616b236d55d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1e2072a0a4f7e3b722a5d5340ba349f242c42281bad9a2d11ae5696626569900 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_26d552317520a35fb18f6d9abbe8e0f0cf2e591a3405be806bb9e01f2848a1e7 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_12b0f3f5ccd9b6b81cbe74f5c217a041841bef8709c94615a7965a71023ef1ee : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_17358eb9253ad6bb2f4bede1ff837f730ce8de75135eff205ac4e35c3161fe20 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_55e65e78b7871dd3592ec4e2cf9bb1f47f84b98dd77e0a16330d505b67a46d11 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_be3bc58dd8222ea5eb97ff9f361e9f96652e971d1e0a56363fd165fb23b33bce : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_68cfcab2a24909b2a97a3f2a717840fd9d71a37b41021e7b720e011126001cd3 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4987adc9e69f986d8c09e24c7c0951ceaa8aa49b68962d8761b68ed078d2f082 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6f4dd73cebb7994893573d48125288adec1c6ca41f5bfcd16f033a698e0a6519 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_16cd6065aeddc47e3d9ddb76d3a7c8adaa9b2eb99982da5aa8b48726e60e7fda : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_p missingname_4a36496d68fbc802c29b89e9e1526b6285618c055fb8b91da2142ee81a389fe1 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
