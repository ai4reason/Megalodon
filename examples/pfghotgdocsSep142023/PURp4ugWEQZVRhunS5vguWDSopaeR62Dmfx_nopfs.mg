...
Definition missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_b761f1af0911416e2c28cbed54918aaaa602a0c11b5236cf68f3bda7a353c7bc : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_baa912ae24f8d2ef3767355d55df50b1349142295576e91e2f49d5296b3cdaba : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7363aaa94ddd44283cfa4307319d052d1a01a83ddb0f3d5b13126c6d6ffe4875 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bd5a833bdc8159826b6cd50a49fb5c3a5e55023f6f3d794ddec42c99e45830d1 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_98d2820488cc585aeb101b9c93de9746f2a381aaa4d32c91115e573b1be77046 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b80f0366c637275f27b2db5c7323352b2752eecb5938082d0278f80f3ee2ce32 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6d0dd4b58767d285dacbd2182496c5f5dd3011ffb7b3a64b86e117350a8b7680 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_83ffaf2b6c22e69125e78476a7cb72afb34ff3712146b43cabf57f86145ac359 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c9696e5fee577899ac031c3f1a74b211ba3f8a4e13204ab9b7b4f71c7bdc7110 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7c1d7ed96234d0e8048ccfe1034964efd7a0cd13c74c264db485076b8f40fa48 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1204213bcb7b1b6688b9bb887413f450f7f6e265db02e6ea535da6c65d029e6e : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_p_e missingname_5ef3c6eda89063424157bd28a9796eb63b447fa0fced60a1fc86b620add37ee0 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
