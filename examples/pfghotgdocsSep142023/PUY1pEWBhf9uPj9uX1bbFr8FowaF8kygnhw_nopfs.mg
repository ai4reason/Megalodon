...
Definition missingname_b9d766b3b2821eb2774856c22eff5b82b876eae9318ef86bdebd6c9a619cd481 : (set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set) -> (set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set) -> (set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set) -> set -> set -> set :=
...
Theorem missingprop_b769593bd367f72dad709cc3eade79aa59e5464fff43e13dec8101cc4ee58b7f : (forall x0 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, x0 u12 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x14) -> x0 u13 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x15) -> x0 u14 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x16) -> x0 u15 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x17) -> x0 u16 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x18) -> (forall x1 x2 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, Church17_p x1 -> Church17_p x2 -> (x1 = x2 -> (forall x3 : prop, x3)) -> missingname_b9d766b3b2821eb2774856c22eff5b82b876eae9318ef86bdebd6c9a619cd481 x0 x1 x2 = TwoRamseyGraph_3_6_Church17 x1 x2)).
admit.
Qed.
Theorem missingprop_5392bfe0fb9a6d7df274dca19ebe5a31891065d0cfb4943f01af03bf28033833 : (forall x0 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, x0 u12 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x14) -> x0 u13 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x15) -> x0 u14 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x16) -> x0 u15 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x17) -> x0 u16 = (fun x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 : set => x18) -> (forall x1 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set, Church17_p x1 -> missingname_b9d766b3b2821eb2774856c22eff5b82b876eae9318ef86bdebd6c9a619cd481 x0 x1 x1 = (fun x3 x4 : set => x4))).
admit.
Qed.
Definition u17 : set :=
 ordsucc u16.
Definition missingname_00cf3208c185bf42883573e65e5daa247f9ab56a27d6bbe7f810ee84a3e943ba : (set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set) -> set -> set -> prop :=
 (fun x0 : set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set => fun x1 x2 : set => x1 :e u17 -> x2 :e u17 -> missingname_b9d766b3b2821eb2774856c22eff5b82b876eae9318ef86bdebd6c9a619cd481 x0 (x0 x1) (x0 x2) = (fun x4 x5 : set => x4)).
