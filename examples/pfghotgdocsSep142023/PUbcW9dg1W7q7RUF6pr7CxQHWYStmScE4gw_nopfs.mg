...
Definition missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_57ff63f258b5580fddba42d14908ef3448739859010b64298483c92c6a2aace3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3909c871986320feb4c8bbad76452877aeea896866550b1378d1022c7c9add51 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_36a6fd1a485684e42c28be3b5e5fa47b7f7df7920a764d6d951e2f6c57ec70e8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a837881ac5fac4a9121aa2f242b791c3477422b81140398027dbdd79d2aa53ef : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4a5173a33c41661626145acae364f41f56e23a7238ae94b95dc308cdff596f45 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2ca58f1742558d80bb54430e3749621ac9af01cd44b142dbce3179b8eb4228c7 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ee2afafe64f35162b03fabc1585447c7996f645ea0e5e28963b1a44269e77ce0 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_35eb89347c544334bacc0ae75f8c8de0157e722ecd716742c0b65c0124d9762a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9b2adc345e1aa5265a3133170bceaf2265eb2ea6375833462c7ddbe02fda33fe : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_efef3daded420a60cd55e40d86533e6b38cc562af6f4b02f35a2cd43b46f817c : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dcfe6869906ad350d366da1e8d76a70e4faa1908dc9411c7844dd80c2ef8889f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_85f09e823968ec374d58edc9dd6fb273cbf1d039d017c5c62e371f8573691fea : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_r_e_e missingname_e071e70c7d00d03811bc0f9e1955d3fcab31fb9c79fd8ccf8c829b0dfe19e419 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
