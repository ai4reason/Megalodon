...
Definition missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (BinRelnHom x0 x1 x2) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_ef703eaa03646e436b19ae1e67c622f4b4842c31e18e8e6427984f3bb98eb7c1 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ed7572cfa099e734ea483bf3fa569a1e73ca6499c4ec1e2bdde207b5ce6e4b37 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_934e2c6579fff4a199c91860f8d1f1a0574f75a412a5410f8963e9d2dcf0b3b5 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ac246c5c822a9369ea01e39e6bfe3f972ffecfa8bf9fb464a7c464d8e2a4fd81 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_432925fd43325ad9e4a61d44cb34b7901f6975ffdb548e3751e2f1e0de9b7c53 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6fe70f53194061f4d28bb5722e6f807dee341d66e206b8cb2b89fabc584cafbb : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a0973d2e5e343a3c57d85de8d93508b061830c5e1e2114f9bcbfa3d6784989aa : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_003d1116efa6f4e8194ff16449c64d0e21cde36cf462a4808bdcc0a697f83363 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0a47ed9da3fb0c2af78b601d76dd6c0ef6194f54e29670ff4516e13b0338ecea : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f63f57e028a341d8f808ffd4ffab7b15b34064a014c818d8bd3bcbef74accfcd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_900124dd934a1a2e180e936f1e4e7c8ef5c79d55646769868f1a285d6da9f097 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_74d76ca7f3a4e51f89fce678266c9f5d3e40b215984b29b899352539c2636e96 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_p missingname_e9d7df16055b78558e799213f8fe5c07e87c3e750e7c671c1df7bd2754cde46e struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
