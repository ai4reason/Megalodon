...
Definition missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (MagmaHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)).
...
Theorem missingprop_42d7c8fb27bbfc682feac48794f49fae70b4726f53592e4f26570fa07e95e07f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_816988b03ce177c6621717874f04b4313fde805fbaa933ae46e2dd25d05abb22 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e3bdea38de434c3ed4f6dfd3f6fa79c5c681a03b04d08debce6af73eb9998ad6 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3145ad2b975cd8480e5dc20fb00410dae0db81eb844eb4414ee1d3adf1f2b9ba : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5555eceae0fdf681fde560fd1b28b2abd8385367cea7fe4bc831bcf05d69edb6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_12d0007a882933d96d1528f4365cef3c7214eb73b0cf9fef19024e9ad438e5cb : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_73275ae81b4f369c2c2da976ba3d85e3cc929e9ba72eb6859ea0d022df639a6f : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_381d8974b4ff7efa51eb734232e678650331b8402820adcc344e95c8942cdccd : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_74519fce62e2e50d3f839859651b416ae2b458abbabfe0698a0abce4424f0ec2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ec8b2039eee6fac45452a0297ac43533ba41b5b88beba7643d59317a80abc444 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7a1c6cd038055adca42a57df6a467d383401f9395befeb8d687478e58250e1b3 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c382ece6c72c305a19acbb285417c42c5a9c0b9b81b0e8d2c28217287189d996 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_u missingname_618408065301fcecbfdb4a63c9ae0a1eb52a69151ce5a1116f9f1bf1905bd843 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
