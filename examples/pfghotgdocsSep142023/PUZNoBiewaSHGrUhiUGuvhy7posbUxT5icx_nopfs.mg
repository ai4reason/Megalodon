...
Definition missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (BinRelnHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_f6f19c6abb2475f6989afbc71a7bef9c9c8d2edfa56639f4e68ecc78ff52cbe0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_00d08a57ea86b3f154f89fc9adb9b46148305d853c74b1e603875ba9a66f98b8 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_849ed30d4730ea10d943f1be7a693826f5dcfc5c8533a0fbb834d47985e4d51a : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_83b132f490be01409bc46f8050d7fd753088eed5e1803b633faad5db9aee762b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6bbe038c97906b085db4ca4c15997085f08907a94034c3c18310f5c22eb21454 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6b9d5bd9fbe5dde3b065963522a5eebfcacb00675b0fb0103545142273067da6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_385983029b7c23e032513012d14fb47231429efb7a5329f3fd9f2f3759255ac8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1946b1e9153f2e726fd91c0b3ce2a84980e2237e9cf2cd6834f21793bb190c07 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_41dac018175bb745d1a10493720fa4dfc53d09ffda75d77126f6a28df7378d68 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ffaf6a61082f80447795451b492010bdd1d2f81a7da2c91159bd6f698731e2f0 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_r_e missingname_0334ec74b66cc99691e47f7636c31147d7db45c239e83d26aaedac93ee4e315e struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
