...
Definition missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (MagmaHom x0 x1 x2)) (MagmaHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_1edfb3de921da063b66d36a5c0b997349f595d8dc7c50036aea5c11b27bc8530 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_153a7285d183178b46f280152dd27d27c61d28f3f16cabec680db7ff7ccb142f : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_1c231f553e24266082766e5fb031067e5e2264b7d0505daddaabcf95bfe8ebfa : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a7721eead499b4609df314b02db3133c39a8b0254e347341575c5b182bedd1d3 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fbbd338a9e507386b0e27c3f602b236d050b011cb05be5b98627561c7ad33cbf : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_86038dcdc48fd743fe38f5e425355c60d5c0b85ba506e8cc2c7fc5b02a475b71 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_40e15b4eb5f95cd5da21aa33367068b2b5dd63fe926db54e47f9987a2a3bd7a8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c8ba76f0a4e5481bf72c0785613af9b19c01b17aa82ccb929a58205154a85686 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a1014204fa20cd8ed7e003b0b6aaa91943c85d26a252218efa8315d7adb8e935 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4128ce9ee88fcc2b33d37b589286d6746815c28b8b56e40ff18f42f354ce5422 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_143ece254a81747c8f5e0f5ff708507a3da75611649f5e16b770dad6498b648a : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_b_b_e missingname_e19f0807cddfaa7a85ec02bbadf2f068197e0a87d9add5731e3900b55be4f63b struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
