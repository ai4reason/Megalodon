...
Definition missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (BinRelnHom x0 x1 x2) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_ac1a276a9fcdccb178609d34899f0aeba85fffe06d56a940f24a2fe9a6aefb40 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6a8a5d1a780afa383f8df10426b18672827e486ffaa7d5dfb1486fe6940f18fb : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dd48567d65ff81c680abc882264e2afa323656e3241922c45914201236ab9ef5 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ac4d72031dfac518b8d279b7cbb6996e1f78a932d8ea559cbb5280107bef1c96 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2376b84c5fedfc6e0f6b9778fc7f72ac827273a946e0a69563bccf4962b93196 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_dea93f90335fb02b4de639f91d1e63cb548f8583d851afc4a6a8f12705ee2699 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fb0b748defadea8d9af141f9a846665d7c1aa96ad2fa634ed8d442092e5d41fa : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b262f4f267b5b9f222741e83ed301773be02395d726f2fc32d680d1acbdcbbff : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_51802f3f5a96a348e5f312a0ac772ea92650c1859d9acd39c99b84de65e39a98 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8a0d1b08ed733bda19ae4be37c7b5b4dc07533199cbf051c773fefe2ac8ea6c2 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bbe91bab081be086b054306ea547af5bfd61930d126c8a16a16db8d379a207fe : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_35b715967c6ba3bd9fb54dac38ecdd5b4ab8ed6278ca62c6c2c1b4914616c123 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_e missingname_741cdb730dfe0b2c724299935cd674ca66081850cc6792785d9d9f6518bf8ac8 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
