...
Definition missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (MagmaHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_68845527eb2b47bb7ef456220cc87b05776ca38dfc98cf972e95da9e5a966f3e : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9ba91d35a50054ba14a2de503196a5c20b5f546161a2798cc0f1dcd84d6a09a0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_85e2edd351321bce1b7245598bb830d57fae4693dc83892bb4de44a0591dd796 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_73956925220e47b858c0d7f6cb8e5631364024b2bde5fe84823597ab4eea4eb2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_135ff5ca9d60da70d85f1417dc532ff34ec461685a70207a4026c062f7c85050 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_bd0ede5480186d64f65d0ed6958e981803fba65b3013d60283267a578a3117e2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ca2a6c3bbf52a296253ad419241a55d9a4bff925ac4dc274d79177cb34f463e8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_cc3aa1c0fb1adf75ac26fb660398c74e0bb934daafd9d0175f4708d092876e26 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_46879507ccf3686e9122fdf7625fd751a587331a42056f80edcbeed93824a182 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4eb206a18b0d124692cb37ea13eefd27e72bd9a2ef4b4ac90a7b2989693a3974 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5f5c4908bbcdd27f3fdcb6bea414178cb6e4904c473ce02a26a30375a8172b65 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_da2393beab60b81ffc471208fc2e2f7473f2fb0b462bca6fbd7d7eaf3394f557 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_b_r_p_p missingname_edc7b7bc2d254017a5dbcb717805f7904a7b7c9ce9801f0a1f7160990ff2d5a6 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
