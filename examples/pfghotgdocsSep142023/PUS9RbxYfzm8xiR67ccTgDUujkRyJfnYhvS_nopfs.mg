...
Definition missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (UnaryFuncHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_00ad35ba42f19fe895b172152a1316bd04e930c08fbbd1435b3d22130e97cb0d : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ce7aa87280b951397ab30e6637e29ef891bc7854e6192f1ae3dbe48cf1f50d9a : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ba16e42c321a46662cffb99ae9ad82e994cb045a1c778feb7a23faeb624dc222 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e9de7af7c6cb59856b7696fb2ee26a22fce42952ef40b224ba22366c47240c4c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4b6c09880de60e642976fd618bc374573e5199010fdebfc179b5b96c149876e9 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a35c8e564299ed6ac18e5f5b56bde1d1780a1c2162880929f5d07eefb8f92f84 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_498a6da88d69a3f52135bba776c89c825ca61662464664e3a832ca2fe6810871 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_681d9aaded33007c1193b8bc8df5c543563dd68bedd2f08c2ddf0a479a282552 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c359df69019c76e24d0b41ae5f07c2641f0c7e06ca97406281203e66d32dba8c : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4b8d6003e2853f9a2e9a1321a39816b7da1ca8efe32ad1362399f439ccd39029 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d386838a40b2dba98dc00bc7f282abf5641e989d7335bd1126e6a154977bb5cc : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_r_e missingname_0c3bc819dc4df382a5947fdbd5e335810e3b9d010a0ab490e1e73161a4d8b58c struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
