...
Definition missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (PtdSetHom x0 x1 x2)) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_b8cad80bddaaa03bd0b9d85714dc098051dd11cb464a66a65dd35caf8e3047e6 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_342f79d9daab63369688638be4b3b2b3a5d5325db29619cc5abc5a67facc22f7 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_02591e9d21ed69eb709014aa7a426f8e4e43c38b97c42bb610961ddcb4902692 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_48fb646e62177a27a57eed6c026c2df8bc1661f48478ce1f2f087b586cd932b6 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_98252a29832dcdf0bc643a81e249c71697bcda0b5c0413529e7f4a786377b91e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c46cb20a1cd2f960a9a727d9c0e1c14074bf64da07f5d2cec79e4d95c4cefbb4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_55de5837c4ea2b7467ab271603891624b6b0fd3ad4f7adf9da849518a5eac2ec : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9c1f0ba7feff3630019cb315c557cdedd844c6932dd4cbf5f7c05c286e2fd8a8 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f4a0fe3039504bcf7472e5b2e9cb201ca8936556895e31819f6ba6f1d1150247 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_3e85bc5a2e1f7aa52ec197a3351965760efe11a9c4a64e849d2b9924121c9bbd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b6e68e40b1160f169a71c6b9e0d032097cf1e37025715e1f72d79caf35acdfdf : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_e_e missingname_d1b9b0d53359c14782a98f272929bdbf46bc6aa4f759024eee6a03e2efed0aa6 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
