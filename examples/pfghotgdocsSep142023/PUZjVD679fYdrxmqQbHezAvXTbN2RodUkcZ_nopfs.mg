...
Definition missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (UnaryFuncHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_5bb45bafba647970f7ef52062f3e2a270738a549b15d21a90f7bb0ed746090c4 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_79cf773b48ef4ab3ecf9a6c0ae6c474be4a3be235b482b4eff47f8505475eecd : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4ffc955b2f9d389159a2718dd0d0d4f706bdfbc072c7f10433b86bbc99e88f0b : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_faed13df67e15cc3b006b71d13151de1b6d349805c7c8f68bf8acce365e695cd : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5ddd25a468caa7d7378b4525cdf642df2207a45ec1b26f1c19de4065184ac202 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9a64c94d54dec70124279f07ce351e29d597ae4a3fb178e91541ef5c3ca14fad : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d9ed836815403c8c10c2b9ac7b25ea0b0f5043ac4fcffafb30dc678dbb7f7928 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b79694a4904fdb354e2933a8e41f7f8d017d67225326fe04f78f399e1d7e2934 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_23a380423dd9c492a1fb95333b8209007ba8bb42f0ad3499487ec35fdb8bbb43 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_def334944c2ca667ceecace677d95e4a7b09475109aa019688a3836228d0ec06 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4aa1eb098a2649b0dcfbd88e7bda80a0e9d8af94c4034250fb493bd8d346a213 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_eaa697711d6135c7ea5260f2c787240eac08871593d5363d9eb027976f6e464f : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_u_r_p missingname_362090e95d458c05dfa979d76ef094e6b95c52eaee0475af52c87b0de7010685 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
