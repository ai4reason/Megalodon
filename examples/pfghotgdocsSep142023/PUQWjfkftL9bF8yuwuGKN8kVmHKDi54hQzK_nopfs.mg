...
Definition missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (BinRelnHom x0 x1 x2) (BinRelnHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_980fa428280d311f6af603a46786fddd9645484bfb7d5bb1dceafc2669184deb : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_13b6837dbc6665ea393354347b88752494da341db54efc0fa56edf415b438bb9 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_079a85ffdfb880d42724889f6910fd85c6259143730f2600f5cb21863152f961 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d952b0e8dbded80b914a0dd5746d08fa2ac9feabd225348c8b7c5eb84497f8f2 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8c011f73f13a89d3e4c3dc2222ff914bcf0c52592cd11ab53fe8d69572fede23 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_11e13f4819ec8090b9b2b93cef13925bbee5f5dd23f60c38e41b21ced2e49550 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_332b66def1d6dd2503de67a363b80d0340b9732c7d045b833bb092e96e5473f6 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2039f96fb4547c4ea1fe350d73e47960459e9a08b3b89a45f14f25478c91b673 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_96a50aaf88d18e0a13f49f25714ae9e219eb4b324ffa03beac95d9867c6667a0 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_fd2bfae9f9ee6521cf0088f6ce36f29ce657ed7a03afe559fbab2fb9ca819071 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5bb3b2c2daac4100966eb0b814e4676da44239b836a253d092ed8769e04f4a13 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_r_r_p_p missingname_9f4bcfa2fce759e9e9d8b2946265ddf0fa04eb634b5156ce1d52c812dcaaab71 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
