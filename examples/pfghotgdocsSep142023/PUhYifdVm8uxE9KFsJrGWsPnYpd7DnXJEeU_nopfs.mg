...
Definition missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (UnaryFuncHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_2df926b37f128c4ad41b4ef10b275ae1001a35f6207b8a13d30cdd0115c43566 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b5d90b43446ac3fa286f396146ef4564cb08510c995e776ec00b1910a9edec4b : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_8a7379e1da26d7a1a4c0cd0be99092595f5839858ceb58f9010bc5b853c67f47 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_373400cf041b8ececac9d1c38342f2c5d93ad153e4c5e2f80b6e6a44822391ed : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0e89bd034f51f97a25654b09a927c698b7c71fb9a9813752525bde624a71a304 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e550d02dc581ee85d2863a86e3779a9108bd6e5661ce580e50b95bbb58caa5e4 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_70e2e44a17fbf28fd2dc2def7a51d490f2c27107737cabc4620ed49524000d26 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_ea126de3e24f5fb7c3192844eb81d4e944bbf1b806979d50c0f26fe1358a861e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_aee4a1d575a0844b89f32df1f71b3446088ff739bd3f353092ace8fb58d315eb : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_b5d6eb4c4ce75ce764808d9d3470910cd26b15180ff7e0d4c1aead51447c2772 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_2524c2850561c2ffaa1ec4a6dc6af14f943b3c4fd6ec69eab81a83dee63ca3f6 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_u_r_r missingname_d15630f2bbee3b1245d0d4fb7dc1d43d5be5431f932141c8f25ea9416fd1ff67 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
