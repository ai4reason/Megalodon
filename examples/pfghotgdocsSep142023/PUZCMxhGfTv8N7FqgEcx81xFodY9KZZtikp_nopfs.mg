...
Definition missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)) (BinRelnHom x0 x1 x2)) (BinRelnHom x0 x1 x2)).
...
Theorem missingprop_d597a518020e3ece48450fe048d1de6073f36e860e3dfff85347c031362ee1cb : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7529d53d8cac99c575459fcad1c3103bf70bce0a974d1b56d6ec1ddc892f2faf : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_69ab444c2e1b6b736190a11e31dc693f0c8bbc9e6f03e5ca9bce81e4e1e87151 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_52ed4ca97bbfd3375c89e638c94d7b8c04de6b0dc7e4ea31b1f8c75e08472cc8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_46bdd54614506fccc4a242830f7660cb6cea7a548445b3ff4b620756a0ae4a4a : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_35e0b9f6d557f2ace0269ee8ab87051cba2a9683037d60d95994860580b1a03c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_faf5d0dfbbfaa4d4abac3e3e4f4cbc134d6f1a9180291a610269835b318148ab : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_145be3fe8eed23f9c78f5b3288fd93358cd68983127bd9f501b90696048c5815 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_9ce00a128cd570e00dfc19deb93e93da9f2401bd30ca5f90339880351d1ecfba : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_7531cab343fa2f94f7aa75284c1b79958d51facd5e80b613848f4391b711f47e : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_edc64baa2c8d8b10b08e7725e8dbd0e7515fb4eb4c1c0b1eae394aa01068ee47 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b_r_r missingname_7bd46a631edf16249340ac473f9c1aa20cf304c4d39e120b5e9305ec9db4c3f7 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
