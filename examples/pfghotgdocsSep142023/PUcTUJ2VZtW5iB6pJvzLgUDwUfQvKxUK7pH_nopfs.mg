...
Definition missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (and (PreContinuousHom x0 x1 x2) (MagmaHom x0 x1 x2)) (UnaryPredHom x0 x1 x2)).
...
Theorem missingprop_c335aa079ecf963c80e667b0154ec79332978accbf43c166ccc990d9bfe35008 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f929d835c26b5978e85534b6823e51383c86c0fda6c7b527c8a84b29d6bd8418 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_4363d12d476a5c96fe18b6394e19f1c7e6dbac7cc2a19f1d7f590aaad79f46c8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_d7c92d320ad491320f6bb5256231b1b495a1f4704d6a886a50a11f0acee26f79 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_c9d7bb8deddbef3ef524f06c86c72e97639b9fade8dbb0b2ff4a93d09db21b4e : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_00e7cf8d5d5c6b64c4c1d25f952ef716f6778ebea98bb6c569ee144406ffd210 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e54f90713bc4d2155e583e24915e1a1f9d3e9267e8dab2e849efaaff12ee2d9c : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_6d7745d2e8eb018b1959378dacc0497fb0a5d5a24d3017b68a107cbba3604d4f : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_e3743ae3c14111d4f72d3d2fd736a16904dffc081c8c1534c167385e4b6018bf : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, (forall x8 : prop, (forall x9 : set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set, (forall x12 : prop, (forall x13 : set -> set -> set -> set -> set, MetaCat_exp_constr_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 x7 x9 x11 x13 -> x12) -> x12) -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_79c4f1c9995a8bf1180b07d78b4cd35f0633e903c99f14fa109756608649d1d1 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9 : set -> set -> set -> set, (forall x10 : prop, (forall x11 : set -> set -> set -> set -> set -> set -> set, MetaCat_subobject_classifier_buggy_p struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0160d40b1ff75bdea69212a70299012941ba5e2ee53b1c4ab6fc41590b9e737f : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_c_b_p missingname_4c2fd76b6cc35f839d01c9b7809ceaafe044d8d800419a60ba95f3dd8211c3d2 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
