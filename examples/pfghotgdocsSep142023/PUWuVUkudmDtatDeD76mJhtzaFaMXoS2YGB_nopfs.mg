...
Definition missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 : set -> set -> set -> prop :=
 (fun x0 x1 x2 : set => and (UnaryFuncHom x0 x1 x2) (PtdSetHom x0 x1 x2)).
...
Theorem missingprop_413b7a23e5e9626a4e274c442adb2a6c81265a4867a2218c853e2d7c8c7fefb0 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_initial_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_991ab9f746471c73cb9a60a5430584ef1fc6c91cd1542e5bdd300caeb7cc7637 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, MetaCat_terminal_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_a12386cf24c9784ef9386d27a2b4fd419a1d68a65e3541ef72b943d9ce568d12 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_coproduct_constr_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5eeb1df976837ba1a622c1e49fd3463e9dd0e8af31e3c121464a90510677e9f8 : (forall x0 : prop, (forall x1 : set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set, MetaCat_product_constr_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f89d60ea0972816486a9cca358430c3b491bb7cff456a85a4fd76654d62a39c2 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_coequalizer_buggy_struct_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_0d952cc37908fb6ed74fa4578d212de2388c30f54f6e8ce8168cb2a8533d3837 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set -> set, MetaCat_equalizer_buggy_struct_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_5fbc98ee4b03266ac70a5c5180900aa3ecdf0bdbc61ec917b51ee66aab795fef : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pushout_buggy_constr_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_90f8845f3a54322a2f6a816760d297d44d443d91b367b2538797147a992d4030 : (forall x0 : prop, (forall x1 : set -> set -> set -> set -> set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set -> set -> set -> set -> set, (forall x6 : prop, (forall x7 : set -> set -> set -> set -> set -> set -> set -> set -> set, MetaCat_pullback_buggy_struct_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_250776055a2e9635e8f9733a29268c699f3b695d4d472a413e4e31bf7dfd22c4 : (forall x0 : prop, (forall x1, (forall x2 : prop, (forall x3 : set -> set, (forall x4 : prop, (forall x5, (forall x6 : prop, (forall x7, (forall x8 : prop, (forall x9, (forall x10 : prop, (forall x11 : set -> set -> set -> set, MetaCat_nno_p struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 x5 x7 x9 x11 -> x10) -> x10) -> x8) -> x8) -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
...
Theorem missingprop_f924c8e5688c51b53e9b8bebbcf613e6f8ff144059beddde6d4ffe45ab804af3 : (forall x0 : prop, (forall x1 : set -> set, (forall x2 : prop, (forall x3 : set -> set -> set -> set, (forall x4 : prop, (forall x5 : set -> set, (forall x6 : prop, (forall x7 : set -> set, MetaAdjunction_strict (fun x8 : set => True) HomSet lam_id (fun x8 x9 x10 : set => lam_comp x8) struct_u_e missingname_c95d04f2e258f754f762db8d4f92ed2229782984d70221c7913b93aa0e8d3ee4 struct_id struct_comp x1 x3 (fun x8 : set => ap x8 Empty) (fun x8 x9 x10 : set => x10) x5 x7 -> x6) -> x6) -> x4) -> x4) -> x2) -> x2) -> x0) -> x0).
Admitted.
