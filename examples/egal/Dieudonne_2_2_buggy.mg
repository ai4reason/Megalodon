...
Theorem Dieudonne_2_2_4: forall n :e omega, forall A c= R, equip n A ->
 exists f:set -> set, bij n A f /\ (forall j :e n, forall i :e j, f i :e f j)
   /\ forall g:set -> set, bij n A g
       -> (forall j :e n, forall i :e j, f i :e f j)
...
Theorem Dieudonne_2_2_7a: forall x y :e R, x <= y -> 0 <= y + - x.
Admitted.

Theorem Dieudonne_2_2_7b: forall x y :e R, 0 <= y + - x -> x <= y.
Admitted.

Theorem Dieudonne_2_2_7c: forall x y :e R, x <= y -> x + - y <= 0.
Admitted.

Theorem Dieudonne_2_2_7d: forall x y :e R, x + - y <= 0 -> x <= y.
Admitted.
