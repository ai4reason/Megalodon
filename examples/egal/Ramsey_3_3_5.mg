...
Theorem exists_TwoRamseyProp_3_3_5 : exists R:set -> set -> prop,
  forall p:prop,
    ((forall i j, R i j -> R j i)
     -> R 0 1 -> R 1 2 -> R 2 3 -> R 3 4 -> R 4 0
     -> ~R 0 2 -> ~R 0 3 -> ~R 1 3 -> ~R 1 4 -> ~R 2 4
     -> p)
    -> p.
...
claim Lsym: forall i j, R i j -> R j i.
{ let i j. assume H.
  exact LRE i j H
            (fun i j => R j i)
            LRI40 LRI10 LRI01 LRI21 LRI12 LRI32 LRI23 LRI43 LRI34 LRI04.
}
exact Hp Lsym LRI01 LRI12 LRI23 LRI34 LRI40 LNR02 LNR03 LNR13 LNR14 LNR24.
Qed.

Theorem not_TwoRamseyProp_3_3_5 : ~TwoRamseyProp 3 3 5.
assume H1.
prove False.
apply exists_TwoRamseyProp_3_3_5.
let R. assume HR. apply HR.
assume HRsym HRI01 HRI12 HRI23 HRI34 HRI40 HNR02 HNR03 HNR13 HNR14 HNR24.
claim L1: forall X c= 5, equip 3 X -> (exists x y :e X, x <> y /\ R x y) /\ (exists x y :e X, x <> y /\ ~R x y).
{ let X.
  assume HX1: X c= 5.
            ...
            + witness beta. apply andI.
              ...
              * { apply andI.
                  - prove alpha <> beta. rewrite H4. rewrite H3.
                    exact neq_0_1.
                  - prove R alpha beta. rewrite H4. rewrite H3. exact HRI01.
                }
          - witness alpha. apply andI.
            + exact Ha.
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  - prove alpha <> gamma. rewrite H4. rewrite H2.
                    exact neq_0_2.
                  - prove ~R alpha gamma. rewrite H4. rewrite H2. exact HNR02.
                }
        }
      * reflexivity.
    + reflexivity.
          ...
          - witness alpha. apply andI.
            ...
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove ~R alpha gamma. rewrite H4. rewrite H2. exact HNR03.
                }
        }
      * reflexivity.
    + assume H3: beta = 2.
          ...
          - witness beta. apply andI.
            ...
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove R beta gamma. rewrite H3. rewrite H2. exact HRI23.
                }
          - witness alpha. apply andI.
            + exact Ha.
            + witness beta. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove ~R alpha beta. rewrite H4. rewrite H3. exact HNR02.
                }
        }
      * { assume H4: alpha = 1.
          apply andI.
          - witness alpha. apply andI.
            ...
            + witness beta. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove R alpha beta. rewrite H4. rewrite H3. exact HRI12.
                }
          - witness alpha. apply andI.
            + exact Ha.
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove ~R alpha gamma. rewrite H4. rewrite H2. exact HNR13.
                }
        }
      * reflexivity.
    + reflexivity.
          ...
          - witness beta. apply andI.
            ...
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove ~R beta gamma. rewrite H3. rewrite H2. exact HNR14.
                }
        }
      * reflexivity.
    + assume H3: beta = 2.
          ...
          - witness alpha. apply andI.
            ...
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove R alpha gamma. rewrite H4. rewrite H2. apply HRsym. exact HRI40.
                }
          - witness alpha. apply andI.
            + exact Ha.
            + witness beta. apply andI.
          ...
          - witness alpha. apply andI.
            ...
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  - prove alpha <> gamma. rewrite H4. rewrite H2.
                    apply neq_i_sym. exact neq_4_1.
                  - prove ~R alpha gamma. rewrite H4. rewrite H2. exact HNR14.
                }
        }
      * reflexivity.
    + assume H3: beta = 3.
          ...
          - witness beta. apply andI.
            ...
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove R beta gamma. rewrite H3. rewrite H2. exact HRI34.
                }
          - witness alpha. apply andI.
            + exact Ha.
            + witness beta. apply andI.
              ...
              * { apply andI.
                  - prove alpha <> beta. rewrite H4. rewrite H3.
                    apply neq_i_sym. exact neq_3_0.
                  - prove ~R alpha beta. rewrite H4. rewrite H3. exact HNR03.
                }
        }
      * { assume H4: alpha = 1.
          apply andI.
          ...
          - witness alpha. apply andI.
            ...
            + witness beta. apply andI.
              ...
              * { apply andI.
                  - prove alpha <> beta. rewrite H4. rewrite H3.
                    apply neq_i_sym. exact neq_3_1.
                  - prove ~R alpha beta. rewrite H4. rewrite H3. exact HNR13.
                }
        }
      * { assume H4: alpha = 2.
          apply andI.
          - witness alpha. apply andI.
            ...
            + witness beta. apply andI.
              ...
              * { apply andI.
                  - prove alpha <> beta. rewrite H4. rewrite H3.
                    apply neq_i_sym. exact neq_3_2.
                  - prove R alpha beta. rewrite H4. rewrite H3. exact HRI23.
                }
          - witness alpha. apply andI.
            + exact Ha.
            + witness gamma. apply andI.
              ...
              * { apply andI.
                  ...
                  - prove ~R alpha gamma. rewrite H4. rewrite H2. exact HNR24.
                }
        }
      * reflexivity.
    + reflexivity.
