...
- let x. assume Hx.
  ...
  + assume H3: x :e Y. rewrite If_i_1 (x :e Y) (inv B g x) (f x) H3.
    ...
    rewrite inj_linv B A g Hg2 y L2.
...
- let x. assume Hx. let y. assume Hy.
  ...
  + assume H3: x :e Y. rewrite If_i_1 (x :e Y) (inv B g x) (f x) H3.
    ...
    * { assume H4: y :e Y. rewrite If_i_1 (y :e Y) (inv B g y) (f y) H4.
	...
	rewrite inj_linv B A g Hg2 z Hz1a.
	rewrite inj_linv B A g Hg2 w (setminusE1 B {f x|x :e A :\: Y} w Hw1).
	assume H5: z = w.
	prove g z = g w.
	f_equal. exact H5.
      }
  ...
  + assume H3: x /:e Y. rewrite If_i_0 (x :e Y) (inv B g x) (f x) H3.
    ...
    * { assume H4: y :e Y. rewrite If_i_1 (y :e Y) (inv B g y) (f y) H4.
	...
	assume Hw1a Hw1b.
	rewrite Hw2.
	rewrite inj_linv B A g Hg2 w Hw1a.
	assume H5: f x = w.
	prove False.
	apply Hw1b.
