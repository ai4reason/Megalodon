...
Axiom add_HSNo_com_3b_1_2 : forall x y z, HSNo x -> HSNo y -> HSNo z
  -> (x + y) + z = (x + z) + y.

Axiom add_HSNo_com_4_inner_mid : forall x y z w, HSNo x -> HSNo y -> HSNo z -> HSNo w
  -> (x + y) + (z + w) = (x + z) + (y + w).
...
Axiom octonion_E : forall z :e octonion, forall p:prop,
